...
title: Informe mensual de actualizaciones de la documentación
...
## Informe: 11 de diciembre de 2024 - 6 de enero de 2026

### Nuevas páginas

- [Introducción al seguimiento](help/using/start/get-started-tracking.md) - 19 de diciembre

### Páginas actualizadas

- [Limitaciones y protecciones de Journey Optimizer](help/using/start/guardrails.md) - 6 de enero
- [Configuración de correo directo](help/using/direct-mail/direct-mail-configuration.md) - 5 de enero
- [Sintaxis de Personalization](help/using/personalization/personalization-syntax.md) - 5 de enero
- [Introducción a recorrido](help/using/building-journeys/journey.md) - 2 de enero
- [Introducción a las campañas](help/using/campaigns/get-started-with-campaigns.md) - 2 de enero
- [Administrar campañas](help/using/campaigns/manage-campaigns.md) - 2 de enero
- [Delegar un subdominio](help/using/configuration/delegate-subdomain.md) - 2 de enero
- [Configurar el registro TXT de Google](help/using/configuration/google-txt.md) - 2 de enero
- [Introducción al seguimiento](help/using/start/get-started-tracking.md) - 23 de diciembre
- [Lista de campos de eventos de paso](help/using/reports/sharing-field-list.md) - 23 de diciembre
- [Enviar pruebas](help/using/content-management/proofs.md) - 23 de diciembre
- [Trabajar con conjuntos de reglas de límite de canal](help/using/conflict-prioritization/channel-capping.md) - 23 de diciembre
- [Usar audiencias de carga personalizadas para la toma de decisiones](help/using/offers/custom-upload-decisioning.md) - 23 de diciembre
- [Introducción a los canales de comunicación](help/using/channels/gs-channels.md) - 22 de diciembre
- [Notas de la versión 2025](help/using/rn/release-notes-2025.md) - 18 de diciembre
- [Trabajar con fragmentos de AEM](help/using/integrations/aem-fragments.md) - 18 de diciembre

## Informe anterior: 3 de noviembre a 11 de diciembre de 2024
...
- [Crear un perfil de prueba](help/using/audience/creating-test-profiles.md) - 22 de noviembre
...
- [Usar audiencias de carga personalizadas para la toma de decisiones (composición federada)](help/using/audience/custom-upload.md) - 14 de noviembre
...
- [Introducción a Decisioning](help/using/experience-decisioning/gs-experience-decisioning.md) - 7 de noviembre
- [Elementos de decisión](help/using/experience-decisioning/items.md) - 7 de noviembre
- [Métodos de clasificación de decisiones](help/using/experience-decisioning/ranking/ranking.md) - 7 de noviembre
...
- [Trabajar con conjuntos de reglas](help/using/conflict-prioritization/rule-sets.md) - 6 de noviembre
...
## Informe anterior: 1 de octubre a 3 de noviembre de 2024
...
- [Establecer horas tranquilas](help/using/conflict-prioritization/quiet-hours.md) - 22 de octubre
- [Journey Optimizer Experimentation Accelerator](help/using/content-management/experiment-accelerator-gs.md) - 24 de octubre
- [Convertir imágenes a plantillas de HTML con el convertidor de imágenes a HTML](help/using/content-management/image-to-html.md) - 30 de octubre
...
- [Configure su configuración de canal](help/using/orchestrated/channel-config.md) - 14 de octubre
- [Trabajar con eventos de paso de recorrido](help/using/reports/journey-step-events-overview.md) - 21 de octubre
...
- [Probar y aprobar](help/rp_landing_pages/test-landing-page.md) - 27 de octubre
...
- [Introducción a los perfiles en Journey Optimizer](help/using/audience/get-started-profiles.md) - 22 de octubre
- [Introducción a las actividades de recorrido](help/using/building-journeys/about-journey-activities.md) - 27 de octubre
- [Pasar colecciones a parámetros de acción personalizados](help/using/building-journeys/collections.md) - 13 de octubre
- [Condiciones / Optimizar (método de condición)](help/using/building-journeys/conditions.md) - 24 de octubre
...
- [Agregar una acción de canal integrada a un recorrido](help/using/building-journeys/journey-action.md) - 29 de octubre
- [Optimizar actividad](help/using/building-journeys/optimize.md) - 22 de octubre
- [Usar una audiencia en un recorrido](help/using/building-journeys/read-audience.md) - 17 de octubre
- [Optimización del tiempo de envío](help/using/building-journeys/send-time-optimization.md) - 28 de octubre
- [Prueba tu recorrido](help/using/building-journeys/testing-the-journey.md) - 28 de octubre
- [Configurar la acción de campaña desencadenada por la API](help/using/campaigns/api-triggered-campaign-action.md) - 29 de octubre
- [Defina la audiencia de campaña desencadenada por API](help/using/campaigns/api-triggered-campaign-audience.md) - 23 de octubre
...
- [Optimización en campañas y recorridos](help/using/content-management/gs-message-optimization.md) - 22 de octubre
- [Crear una campaña de acción](help/using/campaigns/create-campaign.md) - 29 de octubre
- [Introducción a las campañas](help/using/campaigns/get-started-with-campaigns.md) - 29 de octubre
- [Acceder y administrar campañas](help/using/campaigns/manage-campaigns.md) - 23 de octubre
- [Horas tranquilas](help/using/conflict-prioritization/quiet-hours.md) - 31 de octubre
- [Revisar y activar una campaña](help/using/campaigns/trigger-campaigns.md) - 23 de octubre
- [Introducción a los canales de comunicación en [!DNL Adobe Journey Optimizer]](help/using/channels/gs-channels.md) - 3 de noviembre
- [Integrar Journey Optimizer con sistemas externos](help/using/configuration/external-systems.md) - 28 de octubre
- [Cambiar las direcciones de ejecución](help/using/configuration/primary-email-addresses.md) - 22 de octubre
- [Trabajar con conjuntos de reglas](help/using/conflict-prioritization/channel-capping.md) - 28 de octubre
- [Trabajar con conjuntos de reglas](help/using/conflict-prioritization/rule-sets.md) - 27 de octubre
- [Crear un experimento de contenido](help/using/content-management/content-experiment.md) - 15 de octubre
- [Crear un fragmento](help/using/content-management/create-fragments.md) - 7 de octubre
- [Administrar fragmentos](help/using/content-management/manage-fragments.md) - 7 de octubre
- [Ejemplos de consultas de conjuntos de datos](help/using/data/datasets-query-examples.md) - 17 de octubre
- [Acerca de las protecciones de tiempo de vida (TTL) de los conjuntos de datos](help/using/data/datasets-ttl.md) - 28 de octubre
- [Crear un mensaje de correo postal](help/using/direct-mail/create-direct-mail.md) - 15 de octubre
- [Diseñar contenido accesible](help/using/email/accessible-content.md) - 25 de octubre
- [Usar componentes de contenido de Designer de correo electrónico](help/using/email/content-components.md) - 25 de octubre
- [Diseñe contenido desde cero en Journey Optimizer](help/using/email/content-from-scratch.md) - 25 de octubre
- [Configurar opciones de correo electrónico](help/using/email/email-settings.md) - 22 de octubre
- [Importe el contenido de su correo electrónico](help/using/email/existing-content.md) - 30 de octubre
...
- [Usar Assets en Journey Optimizer](help/using/integrations/assets.md) - 28 de octubre
- [Diseñar una página de aterrizaje](help/using/landing-pages/design-lp.md) - 25 de octubre
- [Definir contenido específico de la página de aterrizaje](help/using/landing-pages/lp-content.md) - 25 de octubre
- [Cree y use formularios para sus páginas de aterrizaje](help/using/landing-pages/lp-forms.md) - 24 de octubre
- [Definir ajustes preestablecidos de página de aterrizaje](help/using/landing-pages/lp-presets.md) - 25 de octubre
- [Limitaciones y protecciones de administración de decisiones](help/using/offers/decision-management-guardrails.md) - 25 de octubre
- [Agregar restricciones a una oferta](help/using/offers/offer-library/add-constraints.md) - 3 de noviembre
- [Agregar una actividad de canal en una campaña de varios pasos](help/using/orchestrated/activities/channels.md) - 14 de octubre
- [Pasos de configuración](help/using/orchestrated/file-upload-schema.md) - 8 de octubre
- [Introducción a las campañas orquestadas](help/using/orchestrated/gs-orchestrated-campaigns.md) - 29 de octubre
- [Limitaciones y protecciones de campañas orquestadas](help/using/orchestrated/guardrails.md) - 8 de octubre
- [Pasos de configuración](help/using/orchestrated/manual-schema.md) - 23 de octubre
- [Cree su dimensión de segmentación](help/using/orchestrated/target-dimension.md) - 24 de octubre
- [Asistente para la búsqueda de datos externos](help/using/personalization/external-data-lookup.md) - 28 de octubre
- [Biblioteca de funciones de matrices](help/using/personalization/functions/arrays-list.md) - 29 de octubre
- [Biblioteca de funciones de fecha y hora](help/using/personalization/functions/dates.md) - 29 de octubre
- [Agregar personalización](help/using/personalization/personalization-build-expressions.md) - 28 de octubre
- [Sintaxis de Personalization](help/using/personalization/personalization-syntax.md) - 28 de octubre
- [Diseño de una notificación push](help/using/push/design-push.md) - 14 de octubre
- [Configuración de notificaciones push](help/using/push/push-configuration.md) - 23 de octubre
- [Acceder y suscribirse a alertas del sistema](help/using/reports/alerts.md) - 28 de octubre
...
- [Lista de campos de eventos de paso](help/using/reports/sharing-field-list.md) - 17 de octubre
- [Resumen del uso compartido de pasos de Recorrido](help/using/reports/sharing-overview.md) - 17 de octubre
- [Actualizaciones de documentación](help/using/rn/documentation-updates.md) - 29 de octubre
