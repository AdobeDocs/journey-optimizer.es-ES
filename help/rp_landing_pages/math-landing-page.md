...
[Explorar la función random](../using/building-journeys/functions/math-functions.md#random)
:::
...
[Más información sobre la función round](../using/building-journeys/functions/math-functions.md#round)
:::
