...
[Explorar Asistente de IA](ai-assistant-landing-page.md)
:::
...
[Obtenga información sobre la optimización del tiempo de envío](../using/building-journeys/send-time-optimization.md)
:::
...
[Descubra los modelos de IA](ai-models-landing-page.md)
:::
...
Obtenga respuestas instantáneas y datos operativos sobre Adobe Journey Optimizer mediante la IA aplicada a la conversación.
...
Genere varias variaciones de contenido y ejecute experimentos para identificar el contenido con mejor rendimiento para su público.

[Aprenda sobre Experimentación con IA](../using/content-management/generative-experimentation.md)
:::
...
[Descubra el conversor de imágenes a HTML](../using/email/image-to-html.md)
:::
...
Obtenga datos operativos instantáneos sobre sus recorridos directamente en el Asistente de IA mediante consultas en lenguaje natural.

[Más información sobre los datos de recorrido](../using/start/ai-assistant.md)
:::
...
- **[Agente de análisis de recorrido](https://experienceleague.adobe.com/es/docs/experience-cloud-ai/experience-cloud-ai/agents/ajo-agent-analyze){target="_blank"}**: realice análisis de abandonos de recorrido, detecte superposiciones de públicos y programaciones y reciba recomendaciones procesables para optimizar el rendimiento del recorrido.
...
- **[Audience Agent](https://experienceleague.adobe.com/es/docs/experience-cloud-ai/experience-cloud-ai/agents/audience-agent){target="_blank"}**: crea y administra segmentos de público mediante IA conversacional, analiza la composición de públicos y optimiza las estrategias de segmentación.
...
- **Use indicaciones bien definidas**: la calidad del contenido generado se ve muy afectada por el objetivo y el mensaje de marketing. Sea específico y claro.
- **Cargar recursos de marca**: proporcione recursos de marca en formato PDF, JPEG, PNG o ZIP (máximo 50 MB) para obtener contenido preciso y coherente con la marca.
- **Use plantillas personalizadas**: aproveche las plantillas de correo electrónico específicas de la marca con hasta 8-10 imágenes para obtener resultados óptimos.
- **Proporcione comentarios**: informe sobre salidas problemáticas usando iconos de pulgar hacia arriba, pulgar hacia abajo o indicador para ayudar a perfeccionar los modelos.
...
[Obtenga más información acerca de los mecanismos de protección del Asistente de IA](../using/content-management/gs-generative.md#generative-guardrails)
...
- **Programar envíos por la mañana para notificaciones push**: para evitar notificaciones nocturnas, programe envíos push por lotes por la mañana con duraciones más cortas (por ejemplo, envíos a las 9:00 con tiempo de espera de 8 horas).

[Más información sobre Optimización del tiempo de envío](../using/building-journeys/send-time-optimization.md)

+++

+++**¿Cuáles son las limitaciones de la optimización del tiempo de envío?**

- **Canales**: solo disponibles para los canales de notificaciones push y de correo electrónico en Recorridos. No disponible en campañas ni mediante acciones personalizadas.
...
- **Limitaciones de API**: los modelos de optimización automática no funcionan con la API de Decisioning por lotes (solo para la gestión de decisiones).

[Más información sobre los modelos de IA](../using/experience-decisioning/ranking/ai-models.md)

+++

+++**¿Qué protecciones se aplican a las decisiones con tecnología de IA?**
...
| Reglas de idoneidad + fórmulas de clasificación | 10 000 combinadas |
| Atributos de perfil por regla | 25 |
| Atributos de datos de contexto por regla | 30 |

[Más información sobre los mecanismos de protección de Decisioning](../using/experience-decisioning/decisioning-guardrails.md)

+++

+++**¿Qué son los agentes de IA de Adobe Experience Cloud?**

Los agentes de IA son asistentes de IA especializados creados en Adobe Experience Platform que utilizan un lenguaje natural para ayudarle a analizar, optimizar y administrar tareas de marketing complejas. A diferencia del Asistente de IA para la generación de contenido, los agentes de IA se centran en datos operativos, análisis de recorrido, gestión de públicos y experimentación. Los agentes disponibles son, entre otros, Agente de análisis de recorrido, Agente de experimentación, Agente de público y Agente orquestador.

[Obtenga más información sobre los agentes de IA](https://experienceleague.adobe.com/es/docs/experience-cloud-ai/experience-cloud-ai/agents/agent-orchestrator){target="_blank"}
...
- **Agente de análisis de recorrido**: requiere los permisos **Ver recorridos** para ver datos y **Administrar recorridos** para crear recorridos. También necesita los permisos **Ver segmentos** y **Administrar segmentos** para trabajar con públicos.
- **Agente de experimentación**: requiere el permiso **Ver experimentos** para ver datos y **Administrar metadatos de experimento** para crear experimentos.
- **Agente de público**: requiere permisos adecuados de administración y visualización de segmentos.
...
- **Analizar abandonos de recorrido**: identifique dónde y por qué los clientes abandonan durante los recorridos y detecte patrones de retirada.
- **Detectar superposiciones de públicos**: analice el solapamiento de público en varios recorridos para evitar la fatiga por exceso de segmentación.
- **Identifique conflictos de programación**: detecte conflictos de horarios entre recorridos programados dirigidos al mismo público.
- **Datos operativos de la superficie**: obtenga datos basados en indicaciones como “muéstrame todos los recorridos activos” o “qué públicos se utilizan en más de X recorridos”.

[Explore el agente de análisis de recorrido](https://experienceleague.adobe.com/es/docs/experience-cloud-ai/experience-cloud-ai/agents/ajo-agent-analyze){target="_blank"}

+++

+++**¿Cómo trabajan juntos los agentes de IA?**

El **Agente orquestador** coordina varios agentes especializados para resolver desafíos de marketing complejos en varios pasos. Por ejemplo, puede utilizar el Agente de análisis de recorrido para identificar puntos de abandonos, el Agente de público para analizar la composición de segmentos y el Agente de experimentación para probar soluciones, todo ello mediante consultas en lenguaje natural. El orquestador determina automáticamente qué agentes implicar y secuencia su trabajo de forma eficaz.

+++

+++**¿Debo aceptar unas condiciones determinadas para usar las funciones de IA?**
...
No. Es posible que el contenido de IA generativa no siempre sea preciso. Revise siempre los resultados generados por IA para comprobar su precisión y asegurarse de que son adecuados para su caso de uso. Comparta comentarios mediante las herramientas de clasificación proporcionadas para ayudar a los ingenieros a refinar los modelos.
