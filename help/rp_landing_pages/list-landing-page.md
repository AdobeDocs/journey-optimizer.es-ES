...
[Más información sobre &#39;distinct&#39;](../using/building-journeys/functions/list-functions.md#distinct)
:::
...
[Más información sobre &#39;distinctWithNull&#39;](../using/building-journeys/functions/list-functions.md#distinctWithNull)
:::
...
[Explorar detalles de la función &#39;filter&#39;](../using/building-journeys/functions/list-functions.md#filter)
:::
...
[Explicación de &#39;getListItem&#39;](../using/building-journeys/functions/list-functions.md#getListItem)
:::
...
[Más información sobre &#39;in&#39;](../using/building-journeys/functions/list-functions.md#in)
:::
...
[Explorar &#39;intersect&#39;](../using/building-journeys/functions/list-functions.md#intersect)
:::
...
- **[Uso de la función `limit` en Adobe Journey Optimizer](../using/building-journeys/functions/list-functions.md#limit)**: aprenda a limitar una lista a los primeros o últimos N elementos mediante la función &#39;limit&#39;.
- **[Referencia de función listSize](../using/building-journeys/functions/list-functions.md#listSize)**: descubra cómo contar el número de elementos de una lista mediante la función &#39;listSize&#39;.
- **[Función serializeList en Adobe Journey Optimizer](../using/building-journeys/functions/list-functions.md#serializeList)**: convierta listas en cadenas con formato personalizable mediante la función &#39;serializeList&#39;.
- **[Función sort en Adobe Journey Optimizer](../using/building-journeys/functions/list-functions.md#sort)**: aprenda a ordenar listas de valores u objetos en orden natural mediante la función &#39;sort&#39;.
