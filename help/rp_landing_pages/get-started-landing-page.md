...
[Comprobación de mecanismos de protección y limitaciones](../using/start/guardrails.md)
:::
...
- **[Introducción al Asistente de IA](../using/start/ai-assistant.md)**: aproveche el Asistente de IA para navegar por conceptos y obtener datos operativos en Adobe Journey Optimizer.
