...
[Explorar la función avg](../using/building-journeys/functions/aggregation-functions.md#avg)
:::
...
[Más información sobre la función count](../using/building-journeys/functions/aggregation-functions.md#count)
:::
...
[Revisar la función countOnlyNull](../using/building-journeys/functions/aggregation-functions.md#countOnlyNull)
:::
...
[Ver función countWithNull](../using/building-journeys/functions/aggregation-functions.md#countWithNull)
:::
...
[Más información sobre la función distinctCount](../using/building-journeys/functions/aggregation-functions.md#distinctCount)
:::
...
[Explorar la función distinctCountWithNull](../using/building-journeys/functions/aggregation-functions.md#distinctCountWithNull)
:::
...
- **[Uso de la función &#39;max&#39; en Adobe Journey Optimizer](../using/building-journeys/functions/aggregation-functions.md#max)**: aprenda a utilizar la función &#39;max&#39; para encontrar el valor máximo en un conjunto de expresiones, con sintaxis y ejemplos.
- **[Uso de la función &#39;min&#39; en Adobe Journey Optimizer](../using/building-journeys/functions/aggregation-functions.md#min)**: descubra cómo utilizar la función &#39;min&#39; para encontrar el valor mínimo en un conjunto de expresiones, con ejemplos y sintaxis.
- **[Función sum en Adobe Journey Optimizer](../using/building-journeys/functions/aggregation-functions.md#sum)**: aprenda a utilizar la función &#39;sum&#39; para sumar valores numéricos, con ejemplos y detalles de sintaxis.
