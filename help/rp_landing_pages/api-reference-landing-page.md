...
description: Aprenda a utilizar las API de la biblioteca de ofertas y las API de envío para integrar la gestión de decisiones con sus flujos de trabajo y ofrecer ofertas personalizadas a escala.
...
[Explorar las API de envío](offer-delivery-api-landing-page.md)
:::

:::
![icon](https://cdn.experienceleague.adobe.com/icons/list-check.svg?lang=es)

Crear y administrar ofertas mediante las API

Acceda a referencias de API para administrar ubicaciones, reglas de decisión, cualificadores de colección, ofertas personalizadas, colecciones, ofertas de reserva y decisiones.

[Examinar la API de biblioteca de ofertas](../using/offers/api-reference/getting-started.md)
:::
