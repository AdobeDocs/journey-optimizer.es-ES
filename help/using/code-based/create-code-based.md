...
1. Edite el contenido como desee mediante el [editor basado en código](#edit-code).
...
>title="Uso del editor de código"
>abstract="Inserte y edite el código que desea enviar como parte de esta acción de experiencia basada en código."
>additional-url="https://experienceleague.adobe.com/docs/journey-optimizer/using/personalized-dynamic-content/personalization/build-expressions/expression-editor/personalization-build-expressions.html" text="Introducción al Editor de expresiones"

1. En la pantalla de la edición de la campaña, seleccione **[!UICONTROL Editar código]**.

   ![](assets/code-based-campaign-edit-code.png)

1. Se abre el editor de código. Es una interfaz de creación de experiencias no visual.
...
1. Introduzca el código según sea necesario. El editor de código aprovecha el [!DNL Journey Optimizer] Editor de expresiones con todas sus capacidades de personalización y creación. [Más información](../personalization/personalization-build-expressions.md)

   ![](assets/code-based-campaign-code-editor.png)

1. En campañas basadas en código, puede utilizar la función de Experience Decisioning. Seleccione el **[!UICONTROL Decisiones]** en la barra izquierda y haga clic en **[!UICONTROL Crear decisión]**. [Más información](../experience-decisioning/create-decision.md)
...
1. En el editor de código o en la pantalla Editar contenido, seleccione **[!UICONTROL Simular contenido]**.
