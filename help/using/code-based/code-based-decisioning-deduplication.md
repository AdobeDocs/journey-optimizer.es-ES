...
Al usar [políticas de decisión](../experience-decisioning/create-decision.md) en sus experiencias basadas en código, aprenda a aplicar la anulación de duplicación a sus solicitudes de toma de decisiones en su implementación de cliente.
