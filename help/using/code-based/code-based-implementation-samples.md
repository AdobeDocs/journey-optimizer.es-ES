...
➡️ Obtenga más información acerca de cómo configurar Web SDK para experiencias basadas en código y de toma de decisiones en [estos tutoriales](code-based-decisioning-implementations.md#tutorials)
...
1. [Web SDK](https://experienceleague.adobe.com/docs/experience-platform/edge/home.html){target="_blank"} está incluido en la página.
