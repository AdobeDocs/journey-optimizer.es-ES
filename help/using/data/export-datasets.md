...
| Conjunto de datos de evento de comentarios del destinatario secundario de AJO | Eventos CCO del correo electrónico (destinatario secundario) cuando el archivado de CCO está habilitado. Para consultas y reconciliación con el correo electrónico enviado. |
...
| AOOutputForUPSDataset | Contiene todas las pertenencias a audiencias de AO que se van a escribir en el servicio de perfil unificado |
...
| Repositorio de objetos de decisión: ofertas personalizadas | Repositorio para un tipo de oferta que crea un usuario. Por lo tanto, este conjunto de datos contiene los atributos sobre este tipo de oferta. |
| Repositorio de objetos de decisión: ubicaciones | Repositorio de objetos que definen la ubicación de donde debe mostrarse una oferta. |
| Repositorio de objetos de Experience Decisioning: elementos de oferta personalizados | Almacena todos los elementos de oferta, incluidos todos los atributos y el estado del ciclo vital para admitir la personalización y la creación de informes entre canales. </br> Después de agregar nuevos campos de atributos personalizados al esquema de elementos de oferta, puede haber un retraso de hasta una hora antes de que estos nuevos atributos sean visibles en el conjunto de datos. Para evitar posibles pérdidas o incoherencias en los datos, se recomienda esperar al menos una hora antes de realizar cualquier cambio o actualización que dependa de los atributos recién añadidos. |
