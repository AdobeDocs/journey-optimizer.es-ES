...
**En esta página:** Comprenda los límites de retención de tiempo de vida de los conjuntos de datos generados por el sistema de Journey Optimizer para que pueda planificar cuánto tiempo permanecen disponibles los datos de seguimiento, comentarios y recorrido y conservar los datos críticos antes de que caduquen.
...
Este cambio se aplicará en **zonas protegidas de clientes existentes** a partir del **1 de octubre de 2026**.

## Conjuntos de datos afectados {#datasets}

En la tabla siguiente se enumeran todos los conjuntos de datos generados por el sistema de Journey Optimizer con su respectivo tiempo de vida en el lago de datos y el [almacén de perfiles](https://experienceleague.adobe.com/docs/experience-platform/profile/home.html#profile-data-store){target="_blank"}. Los conjuntos de datos de series de tiempo están sujetos a TTL; los conjuntos de datos de tipo de registro se enumeran para referencia y se marcan `n/a` en ambas columnas. La columna Disponibilidad indica si un conjunto de datos se incluye de forma predeterminada o requiere un complemento o una licencia específicos.
...
+++¿Cómo se notifica a los clientes antes de que el TTL se aplique en las zonas protegidas existentes?

Adobe notifica a los clientes afectados antes de aplicar el TTL en las zonas protegidas existentes. Para este despliegue, Adobe envió una notificación interna del producto y publicó este cambio en las notas de la versión del producto, lo que dio a los clientes un aviso de dos meses antes de que la protección entre en vigor el 1 de octubre de 2026.
