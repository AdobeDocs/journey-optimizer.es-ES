...
* Filtro de opciones
   ...
   **Descripción:** La referencia a un filtro basado en un calificador de colección (anteriormente conocido como &quot;etiqueta&quot;) que coincide con las opciones de un inventario mediante sus calificadores de colección adjuntos. El valor es el URI (@id) de la regla de decisión a la que se hace referencia. Consulte esquema https://ns.adobe.com/experience/decisioning/filter.
   **Tipo:** cadena
