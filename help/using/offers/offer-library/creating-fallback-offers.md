...
Se puede acceder a la lista de ofertas de reserva en la **[!UICONTROL Ofertas]** para abrir el Navegador.
...
1. Haga clic en **[!UICONTROL Crear oferta]** y, a continuación, seleccione **[!UICONTROL Oferta de reserva]**.

   ![](../assets/create_fallback.png)

1. Especifique el nombre de la oferta de reserva. También puede asociar uno o varios calificadores de colección existentes (anteriormente conocidos como &quot;etiquetas&quot;) a él, lo que le permite buscar y organizar la Biblioteca de ofertas con mayor facilidad.
...
1. La oferta de reserva se muestra en la lista con la variable **[!UICONTROL Activo]** o **[!UICONTROL Borrador]** , dependiendo de si lo aprobó o no en el paso anterior.
