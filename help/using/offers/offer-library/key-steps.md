...
1. [Crear ofertas](creating-personalized-offers.md) y configurar su contenido y propiedades. Al personalizar el contenido de la oferta (representaciones), solo se admiten determinadas funciones; consulte [Funciones compatibles en el editor de personalización](personalization-editor-supported-functions.md).
