...
Una oferta se puede mostrar en diferentes lugares de un mensaje: en un banner superior con una imagen, como texto en un párrafo, como un bloque de HTML, etc. Cuantas más representaciones tenga una oferta, más oportunidades habrá de utilizarla en diferentes contextos de colocación.
...
>
>Cuando se usa el editor de personalización en Administración de decisiones, solo se admite un subconjunto de funciones (consulte [Funciones compatibles en el editor de personalización](personalization-editor-supported-functions.md)).
...
Puede personalizar las direcciones URL mediante el editor de personalización. Más información sobre [personalización](../../personalization/personalize.md#use-expression-editor). En Administración de decisiones, solo se admiten ciertas funciones (consulte [Funciones compatibles en el editor de personalización](personalization-editor-supported-functions.md)).
...
Utilice el editor de personalización para recuperar los atributos de perfil almacenados en Adobe Experience Platform mediante esquemas de unión. [Más información](https://experienceleague.adobe.com/docs/experience-platform/profile/union-schemas/union-schemas-overview.html?lang=es){target="_blank"} Para obtener funciones compatibles con la administración de decisiones, consulte [Funciones compatibles en el editor de personalización](personalization-editor-supported-functions.md).
...
1. Escriba el texto que se mostrará en la oferta.
   ...
   Puede personalizar el contenido mediante el editor de personalización. Más información sobre [personalización](../../personalization/personalize.md#use-expression-editor). En Administración de decisiones, solo se admiten ciertas funciones (consulte [Funciones compatibles en el editor de personalización](personalization-editor-supported-functions.md)).
