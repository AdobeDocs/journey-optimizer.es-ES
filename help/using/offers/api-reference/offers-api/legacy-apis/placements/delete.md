...
Puede confirmar la eliminación intentando una solicitud de búsqueda (GET) a la ubicación. Deberá incluir un encabezado Aceptar en la solicitud, pero deberá recibir el estado HTTP 404 (no encontrado) porque la ubicación se ha eliminado del contenedor.
