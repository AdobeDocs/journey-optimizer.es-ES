...
Puede confirmar la eliminación intentando una solicitud de búsqueda (GET) a la oferta personalizada y debe recibir el estado HTTP 404 (no encontrado) porque se ha eliminado la oferta personalizada.
