---
title: Actualizar ofertas personalizadas
...
# Actualizar una oferta personalizada

Puede modificar o actualizar una oferta personalizada realizando una solicitud de PATCH a la API [!DNL Offer Library]
...
Una respuesta correcta devuelve los detalles actualizados de la oferta personalizada, incluido su ID de instancia única y su oferta personalizada `@id`.
