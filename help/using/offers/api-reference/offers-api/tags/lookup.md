...
Puede buscar etiquetas específicas realizando una solicitud GET al [!DNL Offer Library] API que incluye la etiqueta `@id` o el nombre de la etiqueta en la ruta de solicitud.
