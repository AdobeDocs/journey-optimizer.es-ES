...
Puede ver una lista de todos los calificadores de colección dentro de un contenedor realizando una única petición GET a la API de la biblioteca de ofertas.
