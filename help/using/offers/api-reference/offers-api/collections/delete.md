...
Puede confirmar la eliminación intentando una solicitud de búsqueda (GET) a la colección. Debe recibir el estado HTTP 404 (no encontrado) porque la colección se ha eliminado.
