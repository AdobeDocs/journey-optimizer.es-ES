...
Puede buscar colecciones específicas realizando una solicitud de GET a la variable [!DNL Offer Library] API que incluye la colección `id` en la ruta de solicitud.
