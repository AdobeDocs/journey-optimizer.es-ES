...
Puede modificar o actualizar una oferta de reserva en el contenedor realizando una solicitud de PATCH a la API [!DNL Offer Library].
...
Una respuesta correcta devuelve los detalles actualizados de la oferta de reserva, incluido su ID de instancia única y su oferta de reserva `@id`.
