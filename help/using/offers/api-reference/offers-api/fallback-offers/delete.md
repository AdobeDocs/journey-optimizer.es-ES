...
Puede confirmar la eliminación intentando una solicitud de búsqueda (GET) a la oferta y debe recibir el estado HTTP 404 (no encontrado) porque se ha eliminado la oferta de reserva.
