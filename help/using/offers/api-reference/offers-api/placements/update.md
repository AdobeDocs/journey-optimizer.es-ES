...
Puede modificar o actualizar una ubicación en el contenedor realizando una solicitud de PATCH al [!DNL Offer Library] API.
...
Una respuesta correcta devuelve los detalles actualizados de la ubicación, incluido su ID de instancia única y su ubicación `@id`.
