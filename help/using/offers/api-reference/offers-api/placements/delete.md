...
Puede confirmar la eliminación intentando una solicitud de búsqueda (GET) a la ubicación y debe recibir un estado HTTP 404 (no encontrado) porque la ubicación se ha eliminado.
