...
| `id` | `@id` The string is matched exactly. `id``name` | `xcore:offer-placement:124541309805b7e8` |
| `name` | A string used to match the xdm:name property of the entities. The string is matched exactly, with capitalization, but wild card characters can be used. `id``name` | `Sales and Promotions Placement` |
