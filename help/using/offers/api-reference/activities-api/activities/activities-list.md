...
Una decisión (anteriormente conocida como actividad de oferta) contiene la lógica que indica la selección de una oferta.

Puede ver una lista de todas las decisiones dentro de un contenedor realizando una sola solicitud de GET a la API [!DNL Offer Library].
