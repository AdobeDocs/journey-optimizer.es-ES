...
Puede confirmar la eliminación intentando una solicitud de búsqueda (GET) para la decisión. Debe recibir el estado HTTP 404 (no encontrado) porque la decisión se ha eliminado.
