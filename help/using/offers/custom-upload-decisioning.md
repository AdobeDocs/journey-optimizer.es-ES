...
En Administración de decisiones, solo se admiten determinadas funciones al personalizar el contenido. Consulte [Funciones compatibles en el editor de personalización](offer-library/personalization-editor-supported-functions.md).
