...
>[!NOTE]
>
>Esta capacidad simula una sola solicitud a la API [!DNL Decisioning]. Más información sobre [Entregar ofertas usando la API de decisiones](../api-reference/offer-delivery-api/decisioning-api.md).
