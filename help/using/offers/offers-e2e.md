...
Los encontrará en la sección **[!UICONTROL Administración de decisiones]** > **[!UICONTROL Menú Componentes]**.
...
1. Crear **reglas de decisión**.
   ...
   Configure dos reglas sencillas usando la variable **[!UICONTROL Perfil individual XDM > Persona > Sexo]** atributo:
...
1. También puede crear un **calificador de colección**.
   ...
   A continuación, podrá asociarlo a sus ofertas y utilizar este calificador de recopilación para agrupar las ofertas en una colección.

   En este ejemplo, cree la variable *Yoga* calificador de colección.

   ![](assets/offers-e2e-tag.png)

   Los pasos detallados para crear calificadores de recopilación se describen en [esta sección](../../using/offers/offer-library/creating-tags.md).
...
1. En el **[!UICONTROL Elegibilidad de la oferta]** , seleccione **[!UICONTROL Por regla de decisión definida]** y arrastre y suelte la regla que desee.

   ![](assets/offers-e2e-eligibility.png)

1. Complete el **[!UICONTROL Prioridad]**. En este ejemplo, agregue *25*.
...
1. Utilice la variable *Yoga* clasificador de recopilación para seleccionar las cuatro ofertas personalizadas que ha creado anteriormente.
...
Ahora que su decisión está activa, puede insertarla en un mensaje de correo electrónico. Para ello, siga los pasos detallados en [esta página](../../using/email/add-offers-email.md).
