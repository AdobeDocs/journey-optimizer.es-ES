...
>abstract="Para cada campo, especifique una etiqueta y la información que desea mostrar con el editor de personalización. <br/><br/> El <b>Ordenar por</b> permite utilizar el campo seleccionado para ordenar las columnas del archivo de extracción."
...
1. Configure las columnas y la información que desea mostrar en el archivo de extracción:
   ...
   1. En el **[!UICONTROL Datos]** , seleccione los atributos de perfil que desea mostrar mediante el campo [editor de personalización](../personalization/personalization-build-expressions.md).
...
1. Ajuste las propiedades del archivo de extracción:
   ...
   1. A veces es posible que necesite añadir información al principio o al final del archivo de extracción. Para ello, utilice el **[!UICONTROL Notas]** y especifique si desea incluir la nota como encabezado o pie de página.
