...
1. Seleccione el menú **[!UICONTROL Admin]** / **[!UICONTROL Data Sources]** .

   Se muestra la lista de las fuentes de datos. Consulte [esta página](../user-interface.md) para obtener más información sobre la interfaz.
