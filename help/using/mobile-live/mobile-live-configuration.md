...
>[!TIP]
>
>Si encuentra problemas con la configuración o el envío de la actividad en directo, consulte [Solucionar problemas de actividades en directo](troubleshoot-mobile-live.md) para ver los pasos de depuración.