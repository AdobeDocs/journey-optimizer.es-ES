...
**En esta página:** Aprenda a crear manualmente un esquema relacional en la interfaz de usuario, agregar atributos, vincular esquemas y crear y habilitar un conjunto de datos para campañas orquestadas.
