...
**En esta página:** Aprenda a utilizar la actividad Cambiar dimensión para desplazar la dimensión de segmentación dentro de una campaña orquestada, por ejemplo, cambiando de listas de deseos a los destinatarios vinculados a ellas.
