...
**En esta página:** Aprenda a agregar y configurar actividades de canal de correo electrónico, SMS, push y correo directo para enviar mensajes transaccionales o de marketing dentro de una campaña orquestada.
...
>abstract="La actividad de correo electrónico permite enviar correos electrónicos dentro de la campaña orquestada, tanto para mensajes únicos como recurrentes. Sirve para automatizar el proceso de envío de correos electrónicos a un destino calculado dentro de la misma campaña orquestada. Puede combinar actividades de canal en el lienzo de la campaña de varios pasos para crear campañas en canales múltiples que puedan activar acciones basadas en el comportamiento y los datos del cliente."
...
>[!PREREQUISITES]
>
>Antes de agregar una actividad de canal, defina la audiencia de destinatario con una actividad [Generar audiencia](build-audience.md) o [Leer audiencia](read-audience.md).
...
1. En el carril derecho, use el campo **[!UICONTROL Categoría]** para elegir **[!UICONTROL Marketing]** o **[!UICONTROL Transaccional]** para este mensaje. Los mensajes transaccionales no requieren la inclusión y son adecuados para comunicaciones urgentes, como interrupciones, emergencias o cancelaciones.
