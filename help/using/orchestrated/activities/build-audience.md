...
**En esta página:** Aprenda a utilizar la actividad de segmentación de audiencia de compilación para definir la audiencia que entra en una campaña orquestada, utilizando una audiencia existente o el generador de reglas.
