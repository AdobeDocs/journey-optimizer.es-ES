...
**En esta página:** Aprenda a utilizar la actividad de direccionamiento Deduplication en una campaña orquestada para eliminar registros duplicados de los resultados de las actividades entrantes antes de utilizar los datos de destino.
