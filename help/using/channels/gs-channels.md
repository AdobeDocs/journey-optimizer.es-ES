...
# Introducción a los canales de comunicación de [!DNL Adobe Journey Optimizer] {#get-started-email}
...
Adobe Journey Optimizer ofrece una variedad de canales de comunicación para interactuar con su público eficazmente. Puede combinar canales de entrada y salida.

## Canales de salida {#outbound-channels}

Estos implican enviar mensajes a los clientes sin interacción previa. Algunos ejemplos son las campañas de correo electrónico y las notificaciones push, donde puede ponerse en contacto de forma proactiva con su público. En [!DNL Adobe Journey Optimizer], los canales de salida admitidos son los siguientes:
...
## Canales de entrada {#inbound-channels}
