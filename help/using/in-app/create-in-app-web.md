...
**En esta página:** Aprenda a crear una campaña de mensajes en la aplicación web en Adobe Journey Optimizer, desde configurar el canal hasta definir la audiencia, los déclencheur y el contenido.
