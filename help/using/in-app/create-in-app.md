...
**En esta página:** Aprenda a crear un mensaje en la aplicación en Adobe Journey Optimizer y a agregarlo a un recorrido o a una campaña, incluida la configuración de déclencheur y la frecuencia de visualización.
