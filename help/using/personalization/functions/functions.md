...
En el [!DNL Journey Optimizer] Las funciones de ayuda del editor de expresiones se agrupan en tres categorías: [Funciones](#functions-helper), [Ayudantes](#helper-helper) y [Operadores](#operators-helper).
...
<table>
    ...
    <tr>
        <td><a href="dates.md#format-date-locale">Formato de fecha con compatibilidad con configuración regional</a></td><td>Esta función da formato a un valor de fecha y hora en su representación correspondiente que diferencia el idioma, es decir, en una configuración regional deseada.</td>
    </tr>
    <tr>
