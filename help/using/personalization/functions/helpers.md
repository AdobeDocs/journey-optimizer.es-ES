...
>[!NOTE]
>
>* [acciones personalizadas](../../action/action.md) y en canales entrantes no admiten la función de metadatos de ejecución (web, experiencia basada en código, mensaje en la aplicación, tarjetas de contenido).
