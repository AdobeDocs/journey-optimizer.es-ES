...
Puede agregar personalización en **[!DNL Journey Optimizer]** en todos los campos con el icono ![agregar personalización](assets/do-not-localize/add-perso-icon.svg).
