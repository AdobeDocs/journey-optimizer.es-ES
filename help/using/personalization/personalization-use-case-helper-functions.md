...
1. [Añada el contenido del carro de compras al correo electrónico](#each-helper).
1. [Inserte una nota](#if-helper) específica del producto.
...
1. Arrastre y suelte un componente de contenido HTML en cada componente de estructura nuevo.
...
1. En la ventana **[!UICONTROL Edit HTML]**, añada la función de cadena `upperCase`:
   1. En la lista, seleccione **[!UICONTROL Helper functions]**.
   1. Utilice el campo de búsqueda para buscar &quot;mayúsculas&quot;.
   1. En los resultados de la búsqueda, añada la función `upperCase`. Para ello, haga clic en el signo más (+) situado junto a `{%= upperCase(string) %}: string`.
...
1. En la ventana **[!UICONTROL Edit HTML]**, añada el asistente `each`:
   1. En la lista, seleccione **[!UICONTROL Helper functions]**.
   1. Utilice el campo de búsqueda para encontrar &quot;cada uno&quot;.
   1. Desde los resultados de búsqueda, añada el asistente `each`.
...
1. Agregue los tokens de personalización para el nombre del artículo, la cantidad y el precio:
   ...
   1. A partir de los resultados de búsqueda anteriores, añada el token **[!UICONTROL Name]** a la expresión.
...
1. En la ventana **[!UICONTROL Edit HTML]**, añada el asistente `if`:
   1. En la lista, seleccione **[!UICONTROL Helper functions]**.
   1. Utilice el campo de búsqueda para encontrar &quot;if&quot;.
   1. Desde los resultados de búsqueda, añada el asistente `if`.
...
1. Active la opción **[!UICONTROL Test]** y haga clic en **[!UICONTROL Trigger an event]**.

   Solo puede activar el modo de prueba después de publicar el mensaje.

   ![](../assets/personalization-uc-helpers-15.png)

1. En la ventana **[!UICONTROL Event configuration]**, introduzca los valores de entrada y haga clic en **[!UICONTROL Send]**.
