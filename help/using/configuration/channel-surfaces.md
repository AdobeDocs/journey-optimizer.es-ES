...
1. Una vez configurados todos los parámetros, haga clic en **[!UICONTROL Enviar]** para confirmar. También se puede guardar la superficie de canal como inclinación y reanudar su configuración más adelante.
   ...
   >[!NOTE]
   >
   >No se puede continuar con la creación de superficies mientras el grupo de IP seleccionado se encuentra en [edición](ip-pools.md#edit-ip-pool) (**[!UICONTROL Procesando]** estado) y nunca se ha asociado con el subdominio seleccionado. [Más información](#subdomains-and-ip-pools)
   >
...
1. Una vez creada la superficie de canal, esta se muestra en la lista con el **[!UICONTROL Procesando]** estado.
   ...
   > * Para **zonas protegidas de no producción** o si el subdominio seleccionado es **ya se usa** en otra superficie de canal, el proceso solo realiza **3 horas**.
