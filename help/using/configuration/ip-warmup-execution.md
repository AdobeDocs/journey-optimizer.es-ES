...
Para definir las fases del plan de calentamiento de la IP, debe seleccionar una campaña para cada fase, configurar exclusiones para dominios y audiencias y administrar la segmentación de perfiles. Cada fase puede contener varias ejecuciones que se configurarán en la siguiente sección. Siga estos pasos:
...
>[!CAUTION]
>
>Cada ejecución debe activarse al menos 12 horas antes del tiempo de envío real y antes del trabajo diario de segmentación por lotes. De lo contrario, es posible que la evaluación de audiencias no se complete.
...
También puedes acceder a los informes desde el [menú Campañas](../campaigns/manage-campaigns.md#access), ya que tu plan podría usar diferentes campañas. [Ver en el calendario →](../campaigns/manage-campaigns.md#calendar)
