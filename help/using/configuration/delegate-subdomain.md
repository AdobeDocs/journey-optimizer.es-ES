...
>[!CAUTION]
>
>No se admite el envío paralelo de subdominios en [!DNL Journey Optimizer]. Si intenta enviar un subdominio para delegación cuando otro tiene el estado **[!UICONTROL Procesando]**, recibirá un mensaje de error.
