...
1. Seleccione el lapso de tiempo en el que se aplicará el límite.
   ...
   * **[!UICONTROL Diario]**: el límite de frecuencia es válido para el día hasta el 23:59:59 UTC y se restablece en 0 al principio del día siguiente.
