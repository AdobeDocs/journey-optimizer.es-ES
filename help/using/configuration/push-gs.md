...
Esta página le ayudará a configurar y comprender los servicios y flujos de trabajo clave que intervienen en las notificaciones push en [!DNL Journey Optimizer]. Obtenga información sobre cómo crear notificaciones push en [esta página](../messages/create-push.md).
