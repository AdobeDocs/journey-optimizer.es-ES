...
**En esta página:** Aprenda a configurar un subdominio personalizado en Adobe Journey Optimizer mediante el método de delegación personalizado, que le permite conservar la propiedad total de sus subdominios y certificados SSL.
...
>[!NOTE]
>
>Si el subdominio está configurado actualmente con CNAME, también puede migrarlo a delegación personalizada. [Más información](custom-subdomain-migration.md)
...
## Completar los pasos del bucle de comentarios {#feedback-loop-steps}
