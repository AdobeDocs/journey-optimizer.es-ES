...
1. Si está editando un subdominio:
   ...
   * Configurado con [CNAME](delegate-subdomain.md#cname-subdomain-delegation), debe copiar el registro DNS de DMARC en su solución de alojamiento para generar los registros DNS coincidentes.
