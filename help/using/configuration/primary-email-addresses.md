...
# Administrar campos de ejecución predeterminados {#change-primary-email}

>[!BEGINSHADEBOX]

**En esta página:** Aprenda a definir y anular los campos de ejecución que determinan qué dirección de correo electrónico o número de teléfono prioriza Adobe Journey Optimizer para enviar cuando hay varios disponibles en un perfil.
