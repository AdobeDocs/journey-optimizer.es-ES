...
**En esta página:** Revise la lista completa de errores de envío de correo electrónico en Adobe Journey Optimizer, cada uno con su etiqueta de error, tipo de error, valor técnico y descripción.
...
| **Destinatario no válido** | Rechazo grave | 10 | La dirección del destinatario no es válida. |
| **Destinatario rechazado** | Rechazo grave | 15 | El ISP del destinatario ha rechazado el mensaje, y el ISP puede bloquear al remitente si el destinatario no está suprimido. |
| **Rebote suave** | Rechazo suave | 20 | Se ha producido un error temporal en el mensaje. Puede tener éxito en futuros reintentos. |
| **Error de DNS** | Rechazo suave | 21 | Se ha producido un error temporal de DNS en la entrega del mensaje. Puede tener éxito en futuros reintentos. |
| **Buzón lleno** | Rechazo suave | 22 | El mensaje experimentó un error temporal de entrega, ya que el buzón del destinatario estaba lleno. |
...
| **Retransmisión denegada** | Rechazo suave | 54 | No se ha podido aceptar el mensaje porque el dominio de destino no está incluido en la lista de permitidos para la retransmisión. |
...
| **Desafío-respuesta** | Rechazo suave | 100 | Es posible que el envío falle de forma permanente, ya que [!DNL Journey Optimizer] no admite un mecanismo de autenticación desafío-respuesta. |
