...
>abstract="Utilice esta guía para configurar las definiciones de recompensa para los proveedores de recompensas de fidelidad, incluidos los campos de comportamiento de definición predeterminada y carga útil de cumplimiento."

>[!BEGINSHADEBOX]

**En esta página:** Aprenda a configurar proveedores de recompensas y definiciones de recompensas, escriba expresiones JSONata de recompensas y comprenda el contexto utilizado para generar cargas de cumplimiento.
...
➡️ [Mira cómo configurar un proveedor de recompensas por fidelidad](#video)
