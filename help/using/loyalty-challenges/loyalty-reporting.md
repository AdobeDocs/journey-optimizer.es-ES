...
description: Aprenda a utilizar los paneles de informes de Retos de fidelidad para rastrear el rendimiento del programa, los resultados de los desafíos y las métricas de tareas en Adobe Journey Optimizer.
feature: Journeys
