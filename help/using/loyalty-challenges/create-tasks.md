...
**En esta página:** Aprenda a crear tareas de lealtad reutilizables, configurar actividades de compra, gasto y evento personalizado, y definir atributos de tarea, elegibilidad y requisitos de finalización.
...
* **[!UICONTROL Valores de evento personalizados]**: escriba los valores para el evento personalizado que deben completar los clientes. Utilice una coma para separar cada valor. Estos valores deben coincidir con las asignaciones de eventos configuradas en el menú **[!UICONTROL Configuraciones de fidelidad]**. [Aprenda a configurar asignaciones de eventos](loyalty-admin.md#event-mappings)
...
>abstract="Para las actividades **Compra** y **Gasto**, use el atributo **[!UICONTROL Elementos aptos y exclusiones]** para seleccionar qué elementos y grupos cuentan para la finalización de la tarea y cuáles están excluidos. Busque artículos o grupos del inventario de productos configurado por los administradores y, a continuación, inclúyalos o exclúyalos según sea necesario."
