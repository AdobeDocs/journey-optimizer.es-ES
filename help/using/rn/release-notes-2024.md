...
<p>Para obtener más información, consulte la <a href="../personalization/aep-data-perso.md">documentación detallada</a>.</p>
</td>
</tr>
</tbody>
</table>
...
**Uso de licencias**: el panel de control Uso de licencias ahora muestra perfiles interesados, en lugar de públicos interesados. [Más información](../audience/license-usage.md)
...
* **Creación de informes**: ahora puede crear paneles de control de creación de informes personalizados de campañas sobre la toma de decisiones sobre experiencias mediante [!DNL Customer Journey Analytics]. [Más información](../experience-decisioning/cja-reporting.md)
...
* **Tablas de búsqueda en eventos**: ahora puede aprovechar los datos de un conjunto de datos de búsqueda cuando se haya definido una relación con un atributo dentro de una matriz de objetos. Los valores de búsqueda estarán disponibles en recorridos (condiciones, acciones personalizadas, etc.) y personalización de mensajes. [Más información](../event/experience-event-schema.md#relationships_limitations)
...
<p>Para obtener más información, consulte la <a href="../start/ai-features.md#playbooks">documentación detallada</a>.</p>
