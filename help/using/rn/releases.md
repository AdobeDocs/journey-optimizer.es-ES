...
| **Etiqueta** | **Propósito** | **Disponibilidad** | **Notas de clave** |
|------------|-------------|------------------|----------------|
...
| **Disponibilidad general (GA)** | Amplia versión de funcionalidad totalmente compatible. | Habilitado de forma predeterminada para todas las organizaciones aptas. | - Listo para la producción y totalmente compatible.<br> - Pueden aplicarse licencias o derechos.<br> - Puede extenderse progresivamente entre las regiones. |
...
No. Algunas funciones se publican directamente en GA o solo en LA, según su naturaleza y disponibilidad.La ruta de lanzamiento está adaptada a cada capacidad para equilibrar agilidad, calidad y estabilidad.
