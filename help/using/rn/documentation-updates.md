...
* Ya está disponible una nueva página para la administración de decisiones. Enumera todos los operadores, ayudas y funciones compatibles al crear expresiones en el contenido de la oferta, las reglas de decisión y las fórmulas de clasificación. Utilice esta lista para evitar errores de tiempo de ejecución. Gestión de decisiones solo admite las funciones documentadas. [Más información](../offers/personalization-editor-supported-functions.md)
