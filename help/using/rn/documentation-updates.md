...
* La documentación de ejemplos de implementación basada en código se ha actualizado para incluir el campo de tokens en propositionAction para un seguimiento y una atribución precisos en Decisioning. [Más información](../code-based/code-based-implementation-samples.md)
