...
* La interfaz de campañas ahora cuenta con dos fichas independientes: **Acción** y **API activada**. La documentación se ha actualizado en consecuencia, con información para cada tipo de campaña organizada en secciones dedicadas para mejorar la claridad y la facilidad de uso. [Más información](../campaigns/get-started-with-campaigns.md)
...
* Se ha agregado una nota a la sección Fragmentos que especifica que, cuando el seguimiento está habilitado en un recorrido o una campaña, si los vínculos están presentes en un fragmento y si este fragmento se utiliza en un mensaje, se realiza el seguimiento de estos vínculos, como todos los demás vínculos incluidos en el mensaje. [Más información](../content-management/create-fragments.md#content)
...
* Las barreras que se aplican a los fragmentos se han enriquecido. [Más información](../start/guardrails.md#fragments-guardrails).

* Se ha agregado una nota para especificar que los vínculos agregados a los mensajes caducan pasados 25 meses y los vínculos a páginas espejo pasados 90 días. [Más información](../email/message-tracking.md)
