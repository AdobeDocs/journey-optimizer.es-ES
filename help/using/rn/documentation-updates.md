...
* Se ha añadido una nota a las páginas Introducción a los perfiles y protecciones para especificar que, al ingerir datos, los correos electrónicos distinguen entre mayúsculas y minúsculas, lo que significa que se pueden crear y utilizar perfiles duplicados al segmentar estos perfiles. [Más información](../audience/get-started-profiles.md)
