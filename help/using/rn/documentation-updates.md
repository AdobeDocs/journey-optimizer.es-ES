...
* Ya está disponible una nueva página **Demostración interactiva** para los retos de lealtad, que vincula una demostración autoguiada en la que se puede hacer clic y que incluye el flujo de creación de retos del experto en marketing (incluye la opción Traiga sus propios datos y los paneles de datos), la experiencia del cliente final y la administración de retos de lealtad en CX Coworker. [Más información](../loyalty-challenges/loyalty-challenges-demo.md)

* Se ha ampliado y mejorado la página **Personalice el fondo del correo electrónico**. Ahora describe el menú desplegable completo **Ubicación de imágenes** para las imágenes de fondo y añade nuevas prácticas recomendadas para los colores y las imágenes de fondo, incluida la recomendación de probar imágenes de fondo en clientes de correo electrónico reales en lugar de basarse únicamente en la vista previa del Diseñador de correo electrónico. [Más información](../email/backgrounds.md)

* Se ha reorganizado y explicado el contenido de **Diseño de contenido desde cero con el Diseñador de correo electrónico**: distingue la estructura de la columna **[!UICONTROL n:n]** de las estructuras preestablecidas fijas, especifica que se puede aumentar el recuento de columnas de una estructura sin perder el contenido existente, explica cómo se apilan las columnas en dispositivos móviles y añade un nuevo paso en el uso de **[!UICONTROL Módulos]** para empezar a crear correos electrónicos rápidamente. [Más información](../email/content-from-scratch.md)

* La página **Diseño de un recorrido** ahora incluye una sección de tutorial completa sobre la nueva experiencia de lienzo, en la que se explica cómo añadir actividades, utilizar los iconos de la barra de herramientas, seleccionar varias actividades para acciones masivas, copiar y pegar actividades, y unir o separar ramas. [Más información](../building-journeys/using-the-journey-designer.md#canvas-capabilities)

* Se han añadido nuevas directrices para verificar envío de acciones personalizadas: la página **Ejemplos de consultas de conjuntos de datos** ahora explica cómo elegir entre los conjuntos de datos Evento de comentarios del mensaje, Seguimiento de correo electrónico y Evento de paso del recorrido según el tipo de acción, y describe cómo resolver un error “Tabla no proporcionada para el conjunto de datos.” Las páginas **Información general sobre los eventos de paso del recorrido** y **Resolución de problemas de la ejecución del recorrido en directo** se han actualizado en consecuencia, especificando que una llamada a una acción personalizada realizada con éxito solo confirma que Journey Optimizer ejecutó la acción, no que el sistema externo haya enviado un mensaje. [Más información](../data/datasets-query-examples.md#choose-the-correct-dataset)

* Se ha añadido información sobre CX Coworker a la página **Trabajar con la IA**, que explica qué es CX Coworker, cómo se relaciona con el Asistente de IA e incluye referencias a la documentación oficial de Coworker. También se han añadido páginas de habilidades dedicadas a cada guía de funcionalidades: [Habilidades de CX Coworker para recorridos](../building-journeys/journeys-coworker-skills.md), [Habilidades de CX Coworker para la lealtad](../loyalty-challenges/loyalty-coworker-skills.md) y [Herramientas de gestión de contenidos de CX Coworker](../content-management/content-management-coworker-skills.md). [Más información](../start/ai-features.md#cx-coworker)

* Se ha descrito una nueva habilidad **Analizar anomalías del recorrido** en **Análisis del recorrido** en la página de CX Coworker. Detecta picos, caídas o líneas planas inesperados en los recuentos de entrada, salida o envío de un recorrido en comparación con las líneas base históricas, y ejecuta diagnósticos de solo lectura para detectar una causa raíz probable. [Más información](../building-journeys/journeys-coworker-skills.md#journey-analyze)
...
* La página **Mecanismos de protección y limitaciones** se ha corregido para reflejar el hecho de que los fragmentos visuales de más de 100 KB o los fragmentos de expresiones de más de 200 KB ya no pueden causar problemas de truncamiento en los envíos de correo electrónico: ahora se aplica un único mecanismo de protección de tamaño del fragmento de 700 KB. [Más información](../start/guardrails.md#fragments-guardrails)

* Se ha corregido la página **Crear una actividad en vivo**: el campo `executionMetadata` solo está disponible para las campañas **Transaccionales activadas por API**, no para campañas de marketing activadas por API como se indicó anteriormente. [Más información](../mobile-live/create-mobile-live.md#metadata)

* La documentación de **Conjunto de datos de evento de comentarios del mensaje de AJO** se ha ampliado para especificar que incluye comentarios de envío del mensaje en todos los canales (correo electrónico, SMS/RCS/MMS, correo directo), no solo por correo electrónico y notificación push. Ahora, también incluye una sección **Clasificar ejecuciones de prueba y que no son de prueba** que explica cómo interpretar el campo `isTestExecution`, incluyendo `NULL` o los valores que faltan. [Más información](../data/datasets-query-examples.md#classify-test-executions)

* Se ha descrito una nueva funcionalidad **Gestión de contenidos** para CX Coworker, que se basa en quince herramientas MCP de lectura y escritura que permiten detectar, crear, actualizar, clonar y publicar plantillas de contenido, fragmentos, páginas de destino y contenido del mensaje en línea en el recorrido y la campaña utilizando indicaciones con lenguaje natural. [Más información](../content-management/content-management-coworker-skills.md#content-management)

* La documentación de **Añadir contenido a la página de destino** ahora describe una opción **Convertir el campo de formulario en obligatorio** para las casillas de verificación de consentimiento: cuando está activada, el formulario no se puede enviar a menos que la casilla de verificación esté seleccionada y se aplique tanto en el lado del cliente como en el del servidor. [Más información](../landing-pages/lp-content.md#use-form-component)

* La página **Introducción a la simulación del recorrido** se ha actualizado para explicar que los nodos de decisión de contenido y el método de regla de segmentación de la actividad **Optimizar** ahora son compatibles con la simulación (anteriormente se enumeraban como bloqueo), con una nueva tabla de **Funcionamiento de la toma de decisiones** que detalla cómo se evalúan la idoneidad de la oferta, las reglas de idoneidad, los públicos y los métodos de clasificación durante la ejecución de una simulación. [Más información](../building-journeys/simulate-journey-gs.md#limitations)

* La página **Conversión de imágenes en plantillas de contenido de correo electrónico** se ha corregido para eliminar un requisito de permisos inexacto: el permiso **Administrar plantillas de contenido** no es necesario para acceder a plantillas y crearlas con el convertidor de imagen a HTML; solo se necesita el permiso **Generar contenido**. [Más información](../content-management/image-to-html.md#access-image-to-html)

* Se ha corregido la página **Sistemas externos (acciones personalizadas)**: el cortacircuitos para puntos finales de acciones personalizadas lentas ahora se activa cuando más del 20 % de las llamadas en un segundo intervalo de 120 segundos superan los **5 segundos** (anteriormente estaban en 10 segundos). [Más información](../configuration/external-systems.md#response-time)

* La página **Configurar la configuración de su canal** ahora incluye una nota en la que se indica que el esquema utilizado para la dimensión secundaria debe tener una clave principal y que las claves principales compuestas no son compatibles. [Más información](../orchestrated/channel-config.md)

* Se han actualizado las páginas **Datos y conjuntos de datos de lealtad** e **Introducción a las fuentes** para incluir LAVA como conector de lealtad y recompensas compatible, junto con Talon.One, Capillary y Kobie. [Más información](../loyalty-challenges/loyalty-data-and-datasets.md)
...
* La página **Añadir fragmentos visuales a sus correos electrónicos** ahora especifica que un fragmento con contenido dinámico y un estado predeterminado vacío aparece en blanco en el Diseñador de correo electrónico; simúlelo con un perfil que coincida para obtener una vista previa del contenido. [Más información](../email/use-visual-fragments.md#fragment-dynamic-content)

* La página **Seguimiento de los mensajes** se ha actualizado para especificar que los caracteres de URL no admitidos (por ejemplo, apóstrofos) deben tener una codificación en porcentaje y que, si no se codifican, pueden romper los vínculos rastreados y los parámetros de seguimiento de URL. [Más información](../email/message-tracking.md#insert-links)

* La página **Envío por oleadas** se ha actualizado para indicar que la última oleada de un recorrido de lectura de público debe programarse en un plazo de **6 días y 18 horas** desde el inicio del recorrido. Si se supera este plazo, se activará un error de validación y se evitará que el recorrido entre en el modo de prueba o se active. [Más información](../delivery/send-using-waves.md#limitations-guardrails)

* Se ha añadido la nueva sección **Suprimir eventos de comentarios** a la página **Recopilación de datos de gestión de decisiones**, en la que se describe cómo utilizar el indicador `dryRun` para suprimir eventos de decisión durante las pruebas y evitar que se recopilen comentarios para los contadores de creación de informes y restricción de frecuencia. [Más información](../offers/data-collection/data-collection.md#suppress-feedback)

* Ahora hay disponible una nueva página **Elija un método de validación**. En ella se compara la simulación del recorrido, el modo de prueba y el ensayo del recorrido: los datos que utiliza cada uno, independientemente de si envía mensajes reales, los errores comunes que se deben evitar y una guía de decisión para decidir cuál es el método adecuado en cada fase de creación de un recorrido. [Más información](../building-journeys/choose-validation-method.md)
...
* La descripción de **Destinos** en **Navegación izquierda > Secciones principales** se ha actualizado para tener en cuenta que las organizaciones con [!DNL Real-Time CDP] o [!DNL Adobe Journey Optimizer] también pueden activar públicos en destinos de personalización aptos, como [!DNL Adobe Target], desde el catálogo de destinos de Experience Platform. [Más información](../start/user-interface.md#main-sections)

* Se han añadido vídeos prácticos a la documentación de Retos de lealtad para crear retos, configurar proveedores de recompensas y monitorizar el rendimiento de los retos. [Mire los vídeos del reto](../loyalty-challenges/create-challenges.md#video), [mire el vídeo del proveedor de recompensas](../loyalty-challenges/reward-definition-guide.md#video) y [mire el vídeo de creación de informes](../loyalty-challenges/loyalty-reporting.md#video).
...
* La documentación de la **API de migración a la toma de decisiones** se ha mejorado con instrucciones completas para migrar objetos de gestión de decisiones a Toma de decisiones. Entre las nuevas secciones se incluyen: referencia de asignación de entidades con diez convenciones de nomenclatura, la cobertura dentro y fuera del ámbito, comparaciones detalladas de los modelos de solicitud/respuesta, tres patrones de implementación (lado del cliente, lado del servidor e híbrido) con gestión de cookies, requisitos de seguimiento de eventos con cinco ejemplos de eventos en formato JSON, requisitos previos para la migración entre zonas protegidas, un proceso de migración de extremo a extremo en cinco pasos y preguntas frecuentes sobre la migración. [Más información](../experience-decisioning/decisioning-migration-api.md)
