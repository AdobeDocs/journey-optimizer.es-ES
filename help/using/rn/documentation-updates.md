...
* Se ha añadido un vídeo sobre el área de reproducción del editor de personalización para ayudarle a aprender a escribir y probar el código de personalización mediante datos de ejemplo. [Más información](../personalization/personalize.md#how-to-videosvideo-perso)

* El número máximo de direcciones en una lista semilla ha aumentado de 50 a 300. [Más información](../configuration/seed-lists.md#create-seed-list)
