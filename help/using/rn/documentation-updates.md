...
* La página Optimización en campañas se ha actualizado para reflejar el hecho de que la optimización ahora también está disponible en recorridos. [Más información](../campaigns/gs-message-optimization.md)

* Se ha añadido un vínculo al tutorial en vídeo que describe cómo aprovechar la optimización de mensajes en una campaña. [Más información](../campaigns/gs-message-optimization.md)
