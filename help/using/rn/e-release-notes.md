...
- **Campañas**
   ...
   - **Programación de campañas de acción**: los programadores de campañas diarias, semanales y mensuales se han actualizado para mejorar la granularidad. Por ejemplo, ahora puede establecer el número de semanas/meses entre programaciones, definir en qué día se ejecutará y decidir la parada después de un número específico de incidencias o en una fecha específica.
