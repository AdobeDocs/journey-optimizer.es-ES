...
| Panel | <ul> <li>**[!DNL Manage standard dashboard]**: leer, crear, editar y eliminar widgets personalizados y esquemas de widgets a través de la biblioteca de widgets.</li> </ul> |
...
| Gestión de datos | <ul> <li>**[!DNL Manage datasets]**: leer, crear, editar y eliminar conjuntos de datos.</li> </ul> |
