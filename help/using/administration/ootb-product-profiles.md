...
Adobe Journey Optimizer está lanzando una nueva función, la creación en línea, que le permite crear y crear sus mensajes directamente desde un recorrido. Para obtener más información sobre esta nueva función, consulte esta página.

>[!WARNING]
>
>Si tiene usuarios asignados al **[!DNL Message Manager]** solo el perfil de producto, sin la variable **[!DNL Journey manager]** perfil de producto, deberá asignarles un nuevo perfil de producto para que puedan seguir editando contenido.
...
**Después del 25 de julio**, los permisos relacionados con Mensajes seguirán estando disponibles, ya que se puede acceder a Mensajes para habilitar la transición y aún puede guardarlos como plantilla.

**A partir del 6 de septiembre**, se eliminarán los permisos relacionados con los mensajes y ya no se podrá acceder a los mensajes.
...
|Administración|<ul><li>**[!DNL Manage subdomains delegation]**: leer, crear, editar y eliminar delegación de subdominios.</li><li>**[!DNL Manage IP pools]**: leer, crear, editar y eliminar el grupo ip.</li><li>**[!DNL Manage PTR records]**: leer y editar registros PTR.</li><li>**[!DNL View PTR records]**: acceso de solo lectura a registros PTR.</li><li> **[!DNL Manage messages general settings]**: leer, crear, editar y eliminar la configuración general del mensaje.</li><li>**[!DNL Manage channel surfaces]**: leer, crear, editar y eliminar la marca de contenido.</li><li>**[!DNL Manage suppression rules]**: acceda a las reglas de supresión: leer, crear, editar y eliminar.</li><li>**[!DNL View suppression list]**: leer y exportar la lista de supresión local.</li><li>**[!DNL Manage alerts]**: habilitar/deshabilitar alertas para recorridos y autorizaciones.</li></ul>|
