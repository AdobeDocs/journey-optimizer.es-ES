...
**En esta página:** Use los atributos del conjunto de datos de Adobe Experience Platform en las reglas de decisión, las fórmulas de clasificación y las reglas de límite para enriquecer la lógica de decisión con datos externos dinámicos que cambian con frecuencia, como el inventario o los precios.
...
* **Canales admitidos**: la búsqueda de conjuntos de datos con Decisioning funciona para todos los canales donde Decisioning está disponible: experiencia basada en código (entrante), correo electrónico, push, SMS y el nodo de decisión de contenido en recorrido.
