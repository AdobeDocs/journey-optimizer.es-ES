...
**En esta página:** Cree estrategias de selección reutilizables que emparejen una colección con una restricción de elegibilidad y un método de clasificación, de modo que una directiva de decisión pueda determinar las mejores ofertas para presentar a cada perfil.
...
>additional-url="https://experienceleague.adobe.com/docs/journey-optimizer/using/decisioning/experience-decisioning/decision-policies/create-decision.html?lang=es" text="Creación de políticas de decisión"
