...
# Preguntas frecuentes sobre Decisioning {#decisioning-faq}

>[!BEGINSHADEBOX]

**En esta página:** Encuentre respuestas a preguntas comunes sobre las capacidades de toma de decisiones, incluidas las reglas de límite, las fórmulas de clasificación y el comportamiento del modelo de IA, para que pueda configurar y solucionar problemas de la toma de decisiones con confianza.
