...
**En esta página:** Configure el catálogo de elementos y edite su esquema para que pueda organizar los elementos de decisión y definir los atributos estándar y personalizados disponibles al crearlos.

>[!ENDSHADEBOX]

>[!CONTEXTUALHELP]
>id="ajo_exd_item_custom_attributes"
>title="Acceso y edición del esquema del catálogo"
>abstract="Los atributos personalizados son atributos específicos adaptados a sus necesidades que puede asignar a un elemento de decisión. Se crean en el esquema del catálogo de los elementos de decisión."
