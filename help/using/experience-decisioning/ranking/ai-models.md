...
**En esta página:** Comprenda los tipos de modelos de IA de optimización automática y optimización personalizada, y los pasos para crearlos de modo que pueda clasificar ofertas según sus objetivos comerciales.
...
1. Monitorice el estado y el rendimiento de la formación del modelo de IA. [Más información](ai-model-observability.md)
