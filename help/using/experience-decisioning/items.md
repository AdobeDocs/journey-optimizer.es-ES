...
>title="Asignar un fragmento de contenido de Journey Optimizer a este elemento de decisión"
>abstract="Adjunte un fragmento de contenido de la biblioteca de fragmentos de Journey Optimizer."

>[!CONTEXTUALHELP]
>id="ajo_exd_item_aem_fragment"
>title="Asignar un fragmento de contenido de AEM a este elemento de decisión"
>abstract="Al adjuntar un fragmento de contenido a este elemento de decisión, puede aprovechar el contenido directamente desde Adobe Experience Manager."
...
1. Si lo desea, puede especificar atributos personalizados. Son atributos específicos adaptados a sus necesidades que puede asignar a un elemento de decisión, definidos en el esquema de catálogo de los elementos de decisión. [Aprenda a trabajar con catálogos](catalogs.md)

   Puede ordenar los atributos personalizados haciendo clic en los encabezados de columna y buscando un atributo específico mediante el campo de búsqueda.

   ![Pantalla de creación de elementos de decisión con la sección de atributos personalizados](assets/item-custom-attributes.png){width="80%"}

1. Para cualquier atributo personalizado definido con el tipo **[!UICONTROL Decisioning Content]** en el esquema del catálogo, haga clic en el icono del editor de personalización situado junto al campo para abrir el editor de expresiones, donde puede escribir código y agregar referencias de atributos mediante la sintaxis del controlador (por ejemplo, `{{profile.person.name.firstName}}`).

   Esto le permite definir un valor evaluado en el momento de la entrega mediante datos de perfil, contexto, recorrido y audiencia, y permite que un solo elemento de decisión ofrezca contenido personalizado a diferentes perfiles sin duplicaciones. [Más información sobre cómo agregar personalización](../personalization/personalization-build-expressions.md)

   ![Pantalla de creación de elementos de decisión con icono del editor de personalización](assets/item-custom-attribute-personalization.png){width="80%"}

1. Añada fragmentos al elemento de decisión para enriquecer su contenido. Se admiten dos tipos de fragmentos:

   * **Fragmentos de contenido de Journey Optimizer**: utilice fragmentos de expresiones reutilizables creados en Journey Optimizer para mostrar contenido diferente en función del contexto, por ejemplo, en varios modelos de dispositivos móviles. Puede aprovechar estos fragmentos en las políticas de decisión en todos los canales donde Decisioning está disponible (experiencia basada en código, correo electrónico, push, SMS y recorridos). [Descubra cómo](fragments-decision-policies.md#ajo-fragments)

     Al utilizar estos fragmentos en las directivas de decisión, puede hacer que un fragmento sea opcional para que se omita si no está disponible temporalmente en Edge. [Descubra cómo](fragments-decision-policies.md#temporary-unavailable-fragments)

   * **Fragmentos de contenido de AEM**: asigne fragmentos de contenido de Adobe Experience Manager directamente a los atributos del elemento de decisión. Rellene el campo **Clave de referencia de fragmento** y seleccione el fragmento en el campo **Valor**. Una vez asignados, los campos de fragmento de contenido se pueden seleccionar en la directiva de decisión y Journey Optimizer puede optimizar qué fragmento se sirve a cada perfil. [Descubra cómo](fragments-decision-policies.md#aem-fragments-decisioning)
...
1. Defina qué **[!UICONTROL evento de límite]** se tendrá en cuenta para aumentar el contador.
   ...
   * **[!UICONTROL Evento personalizado]**: Límite basado en eventos de experiencia empresarial o de comportamiento que rastrea en Adobe Experience Platform, por ejemplo, reembolsos, compras o cierres de compra del carro de compras. El límite de evento personalizado utiliza [Adobe Experience Platform XDM](https://experienceleague.adobe.com/docs/experience-platform/xdm/home.html?lang=es){target="_blank"} eventos de experiencia que usted ingiere. En el menú desplegable, se asigna el evento de experiencia específico que debe controlar el límite para que el contador de límite se incremente cada vez que se recibe el evento. No se admite el límite por eventos de envío de canal, como el envío por correo electrónico: el evento personalizado solo se aplica a los eventos de experiencia que ingiere, no a los eventos de envío o envío.

   +++Límite para el canal push

   Los **[!UICONTROL clics]** y el límite de **[!UICONTROL impresión]** estándar no son compatibles con el canal push. Para limitar las ofertas enviadas mediante Push, use el límite de **[!UICONTROL evento personalizado]** y establezca el tipo de evento en **Aplicación de seguimiento push abierta** o **Acción personalizada de seguimiento push**.
   ...
   +++Seguimiento de eventos de límite (esquema y recopilación de datos)
   ...
   * [Recopilación de datos de gestión de decisiones](data-collection/data-collection.md)
