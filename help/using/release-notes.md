...
En esta página se enumeran todas las nuevas funciones y mejoras de [!DNL Journey Optimizer]. También puede consultar la [últimas actualizaciones de la documentación](documentation-updates.md).
...
<tr>
<td>
<p>Ahora puede simular qué ofertas se enviarán a un perfil de prueba para una ubicación determinada en la interfaz de usuario de Journey Optimizer. Esto le permite validar la lógica de toma de decisiones, incluidas las restricciones de elegibilidad y los algoritmos de clasificación, fácilmente antes de ponerlos en producción. Esta capacidad permite a los usuarios no técnicos y técnicos probar rápidamente el offer decisioning y solucionar posibles problemas.</p>
...
Consulte también [Notas de la versión de octubre de Adobe Experience Platform](https://experienceleague.adobe.com/docs/experience-platform/release-notes/latest.html?lang=es){target=&quot;_blank&quot;} para obtener más cambios.
...
* **Accesibilidad** - Se han implementado mejoras de accesibilidad en recorrido.
...
* **Formato de datos en la vista Global** - Ahora puede alternar entre números y porcentajes en la variable **Vista global** del **Ejecución** pestaña . [Más información](message-monitoring.md)
* **Nuevas métricas** - Las nuevas métricas y utilidades ya están disponibles en **Activo** y **Global** para medir el impacto de las ofertas en los destinatarios. [Más información](reports/journey-global-report.md)
...
<p>Consulte la documentación de <a href="https://experienceleague.adobe.com/docs/journeys/using/building-advanced-conditions-journeys/main-functions-journey/list/functionfilter.html">filter</a> y <a href="https://experienceleague.adobe.com/docs/journeys/using/building-advanced-conditions-journeys/main-functions-journey/list/functionintersect.html">intersección</a> funciones.</p>
</td>
</tr>
</tbody>
</table>
...
* **Buscar** - En todas las páginas, ahora puede buscar objetos empresariales y artículos de ayuda directamente desde el campo de búsqueda del Experience Cloud unificado. [Más información](user-interface.md#unified-search)
...
* **Lista de permitidos** : Ahora, la lista de permitidos se puede habilitar y deshabilitar en un simulador para pruebas que no sean de producción mediante una llamada de API. [Más información](allow-list.md#enable-allow-list)
...
* La identidad y el área de nombres ahora están visibles en el **[!UICONTROL Preview]** en el Navegador. [Más información](preview.md#preview-your-messages)
* El número de correos electrónicos de prueba para pruebas ahora está restringido a 10.
* Caracteres permitidos para **Prefijo de línea de asunto** en las pruebas ahora son limitadas. [Más información](preview.md#send-proofs)
...
* Se ha corregido un problema en el Diseñador de correo electrónico al cargar un archivo de HTML en el que la hoja de estilo interna con `background-image` no se admitía.
