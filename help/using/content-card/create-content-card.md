...
1. Habilitar la opción **[!UICONTROL Habilitar reglas de envío adicionales]**. A continuación, **[!UICONTROL edite las reglas]** para elegir los eventos y los criterios que almacenarán en déclencheur el mensaje. Los generadores de reglas permiten a los usuarios especificar criterios y valores que, cuando se cumplen, entran en déclencheur en un conjunto de acciones.
...
1. En la sección **Audiencia**, haga clic en el botón **[!UICONTROL Seleccionar audiencia]** para mostrar la lista de audiencias de Adobe Experience Platform disponibles. [Más información sobre las audiencias](../audience/about-audiences.md)
...
1. Si se requieren déclencheur adicionales, use la opción **[!UICONTROL Habilitar reglas de envío adicionales]**. No se requieren reglas de envío adicionales.

   Haga clic en **[!UICONTROL Editar déclencheur]** para seleccionar los eventos y criterios para la entrega de mensajes. El generador de reglas permite especificar condiciones y valores que, cuando se cumplen, almacenan en déclencheur las acciones.
