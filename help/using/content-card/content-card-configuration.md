...
**En esta página:** Cree una configuración de canal de tarjeta de contenido y defina su superficie para que pueda enviar tarjetas de contenido a la ubicación web o de aplicación correcta.
