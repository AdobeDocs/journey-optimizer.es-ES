...
>abstract="La actividad de acción Actualizar perfil le permite actualizar un perfil existente de Adobe Experience Platform con información proveniente del evento, una fuente de datos o con un valor específico."

Utilice la variable **[!UICONTROL Update Profile]** actividad de acción para actualizar un perfil existente de Adobe Experience Platform con información proveniente de un evento, una fuente de datos o con un valor específico.
