...
Su recorrido estará compuesto por un **[!UICONTROL Leer segmento]** y un **[!UICONTROL Actualizar perfil]** actividad. Primero debe crear un segmento dirigido a los perfiles que desea convertir en perfiles de prueba.

>[!NOTE]
>
> Dado que va a actualizar el **testProfile** , los perfiles elegidos deben incluir este campo. El esquema relacionado debe tener **Detalles de prueba de perfil** grupo de campos. Consulte [esta sección](../segment/creating-test-profiles.md#test-profiles-prerequisites).

1. Navegar a **Segmentos**, entonces **Crear segmento**, en la parte superior derecha.
   ![](assets/test-profiles-22.png)
1. Defina un nombre para el segmento y genere el segmento: elija los campos y los valores para segmentar los perfiles que desee.
   ![](assets/test-profiles-23.png)
1. Clic **Guardar** y compruebe que el segmento se dirige correctamente a los perfiles.
   ![](assets/test-profiles-24.png)

   >[!NOTE]
   >
   > El cálculo de segmentos puede llevar algún tiempo. Más información sobre los segmentos en [esta sección](../segment/about-segments.md).

1. Ahora cree un nuevo recorrido y comience con una **[!UICONTROL Leer segmento]** actividad de orquestación.
