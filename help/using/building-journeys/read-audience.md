...
* **`inAudience()`tiempo de condición:** Al usar `inAudience()` en un nodo de condición dentro de un recorrido de audiencia de lectura, se lee la pertenencia al segmento de la proyección por lotes del perfil. La actualización de los datos en esta proyección conlleva una SLT de hasta **2 horas** después de la ingesta. Para obtener detalles completos sobre los escenarios de tiempo de propagación, consulte la [documentación de la función inAudience](functions/functioninaudience.md#propagation-timing).
