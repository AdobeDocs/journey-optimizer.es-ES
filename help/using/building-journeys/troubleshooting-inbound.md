...
description: Obtenga información sobre cómo depurar y resolver problemas relacionados con acciones entrantes en recorrido [!DNL Adobe Journey Optimizer]
...
### Paso 1: compruebe si el dispositivo o cliente recibe el contenido de la red perimetral {#step-1}
...
### Paso 2: compruebe si la red perimetral devuelve el contenido {#step-2}
...
1. Vaya al atributo `segmentMembership` y compruebe si el ID del segmento &lt;*JourneyVersionID>*_&lt;*JourneyActionID*> está presente en el área de nombres **joai** y si está en estado **[!UICONTROL realizado]** <!--or existing?-->.
