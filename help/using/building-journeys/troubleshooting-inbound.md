...
1. Si el ID del segmento **joai** no está presente o si está en el estado **[!UICONTROL exited]**, significa que (aún) no se ha propagado a Edge.
...
1. Seleccione la ficha **[!UICONTROL Atributos]** y elija la vista **[!UICONTROL Hub]**. <!--cannot see Hub/Edge wiews for the profile-->
