...
>abstract="La actividad de acción Jump permite insertar a los individuos de un recorrido a otro. Esta función le permite simplificar el diseño de recorridos muy complejos y construir recorridos basados en patrones de recorrido comunes y reutilizables."

La variable **[!UICONTROL Jump]** la actividad de acción permite insertar a los individuos de un recorrido a otro. Esta función le permite:

* simplificar el diseño de recorridos muy complejos dividiéndolos en varios
* construir recorridos basados en patrones de recorrido comunes y reutilizables

En el recorrido de origen, simplemente agregue una **[!UICONTROL Jump]** actividad y seleccione un recorrido de destino. Cuando el individuo introduce la variable **[!UICONTROL Jump]** , se envía un evento interno al primer evento del recorrido de destino. Si la variable **[!UICONTROL Jump]** La acción es satisfactoria, el individuo continúa progresando en el recorrido. El comportamiento es similar al de otras acciones.

En el recorrido de destino, el primer evento activado internamente por la variable **[!UICONTROL Jump]** la actividad realizará el flujo individual en el recorrido.
...
1. El individuo es empujado al recorrido B y pasa a los siguientes pasos en el recorrido A, después del **[!UICONTROL Jump]** paso a paso.

En el recorrido B, el primer evento se activa internamente, a través del **[!UICONTROL Jump]** actividad desde el recorrido A:
...
* La variable **[!UICONTROL Jump]** actividad solo está disponible en recorridos que utilizan un área de nombres.
* Solo puede ir a un recorrido que utilice el mismo espacio de nombres que el recorrido de origen.
* No puede ir a un recorrido que comience con un **Clasificación del segmento** evento o **Leer segmento**.
...
* Puede tener tantos niveles de salto como sea necesario. Por ejemplo, Recorrido A va al recorrido B, que va al recorrido C, etc.
...
* Cuando la variable **[!UICONTROL Jump]** se ejecuta la actividad , se activa la última versión del recorrido de Target.
...
La lista muestra todas las versiones del recorrido en borrador, activas o en modo de prueba. Recorridos que utilizan un área de nombres diferente o que comienzan con un **Clasificación del segmento** no están disponibles. Los recorridos de destino que podrían crear un patrón de bucle también se filtran.

   ![](assets/jump3.png)

   >[!NOTE]
   >
   >Puede hacer clic en el botón **Abrir recorrido de destino** , en el lado derecho, para abrir el recorrido de destino en una nueva pestaña.
...
Su **[!UICONTROL Jump]** actividad está configurada. Tan pronto como el recorrido esté activo o en modo de prueba, las personas que llegan al **[!UICONTROL Jump]** se insertará desde al recorrido de destino.
...
* si el primer evento del recorrido de destino ha cambiado y la asignación está rota
