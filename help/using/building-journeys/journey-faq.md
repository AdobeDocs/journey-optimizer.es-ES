...
**En esta página:** Encuentre respuestas a las preguntas más frecuentes acerca de Journey Orchestration en Adobe Journey Optimizer, que abarcan conceptos generales, actividades, eventos y solución de problemas.
...
Vea [Elegir un método de validación](choose-validation-method.md) para obtener una comparación completa o para obtener más información acerca de [simulación](simulate-journey-gs.md), [modo de prueba](testing-the-journey.md) y [ejecución en seco](journey-dry-run.md).
