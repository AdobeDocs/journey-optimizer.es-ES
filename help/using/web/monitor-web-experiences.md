...
**En esta página:** Aprenda a monitorizar sus experiencias web activas en Adobe Journey Optimizer comprobando los informes web y configurando el rastreo de clics en elementos de página específicos.
