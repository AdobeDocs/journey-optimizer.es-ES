...
>abstract="Para tener acceso al diseñador web [!DNL Journey Optimizer], debe tener instalada una extensión de explorador específica: el Asistente para la edición visual de Adobe Experience Cloud, que solo está disponible en Google Chrome o Microsoft Edge."
