...
* Para tener acceso al diseñador web [!DNL Journey Optimizer], debe tener instalada una extensión específica del explorador Google Chrome. [Más información](#visual-authoring-prerequesites)
