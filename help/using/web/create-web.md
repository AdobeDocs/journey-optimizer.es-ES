...
* Para agregar modificaciones al sitio web, debe implementar la variable [SDK web de Adobe Experience Platform](https://experienceleague.adobe.com/docs/platform-learn/implement-web-sdk/overview.html){target=&quot;_blank&quot;} en su sitio web.
...
>[!CAUTION]
>
>Actualmente, Google Chrome es el único explorador que admite la creación de páginas web en [!DNL Journey Optimizer].

Para que la experiencia web se entregue correctamente, se debe definir la siguiente configuración:

* En el [Recopilación de datos de Adobe Experience Platform](https://experienceleague.adobe.com/docs/experience-platform/edge/datastreams/overview.html){target=&quot;_blank&quot;}, asegúrese de que tiene un conjunto de datos definido como en la sección **[!UICONTROL Adobe Experience Platform]** tiene ambos **[!UICONTROL Edge Segmentation]** y **[!UICONTROL Adobe Journey Optimizer]** opciones activadas.
   ...
   >[!NOTE]
   >
   >La variable **[!UICONTROL Adobe Journey Optimizer]** solo se puede activar cuando **[!UICONTROL Edge Segmentation]** ya está activada.

* En [Adobe Experience Platform](https://experienceleague.adobe.com/docs/experience-platform/profile/home.html){target=&quot;_blank&quot;}, asegúrese de que tiene una directiva de combinación con la variable **[!UICONTROL Active-On-Edge Merge Policy]** activada. Para ello, seleccione una directiva en la sección **[!UICONTROL Customer]** > **[!UICONTROL Profiles]** > **[!UICONTROL Merge Policies]** Menú de Experience Platform. [Más información](https://experienceleague.adobe.com/docs/experience-platform/profile/merge-policies/ui-guide.html#configure){target=&quot;_blank&quot;}
...
1. Defina una superficie web.
   ...
   Puede especificar una **[!UICONTROL Page URL]** si desea aplicar los cambios solo a una página única.

   ![](assets/web-campaign-surface.png)

1. O puede crear un **[!UICONTROL Pages matching rule]** para dirigirse a varias direcciones URL que coincidan con la misma regla; por ejemplo, si desea aplicar los cambios a un banner a pantalla completa en todo un sitio web o agregar una imagen superior que se muestre en todas las páginas de producto de un sitio web.

   Para ello, seleccione **[!UICONTROL Pages matching rule]** y haga clic en **[!UICONTROL Create rule]**.

   ![](assets/web-campaign-matching-rule.png)

1. Defina sus criterios para la variable **[!UICONTROL Domain]** y **[!UICONTROL Page]** campos.

   Por ejemplo, si desea editar los elementos que se muestran en todas las páginas de producto femeninas de su sitio web de Luma, seleccione **[!UICONTROL Domain]** > **[!UICONTROL Starts with]** > `luma` y **[!UICONTROL Page]** > **[!UICONTROL Contains]** > `women`.

   ![](assets/web-pages-matching-rule.png)

1. Guarde los cambios. La regla se muestra en la sección **[!UICONTROL Create campaign]** en el Navegador.

   ![](assets/web-pages-matching-rule-example.png)

1. Una vez definida la superficie web, seleccione **[!UICONTROL Create]**. Ahora puede configurar las propiedades y la configuración de la campaña.

## Configuración de la campaña web {#configure-web-campaign}

1. En el **[!UICONTROL Properties]** , puede editar el nombre de la campaña y agregar una descripción si es necesario.

   ![](assets/web-campaign-properties.png)

1. Para asignar etiquetas de uso de datos principales o personalizadas a la campaña web, seleccione la opción **[!UICONTROL Manage access]** en la parte superior de la pantalla. [Más información sobre Control de acceso a nivel de objeto (OLAC)](../administration/object-based-access.md)

1. Puede seleccionar **[!UICONTROL Content experiment]** para probar los tratamientos de contenido con partes de la audiencia, a fin de determinar qué tratamiento ofrece el mejor rendimiento con respecto a una métrica específica. [Más información](../campaigns/content-experiment.md)
...
1. En el **[!UICONTROL Action]** de la campaña, seleccione **[!UICONTROL Edit content]** para comenzar a crear la campaña web. [Más información](author-web.md)

   ![](assets/web-edit-content.png)

1. En el **[!UICONTROL Audience]** , defina quién podrá ver la campaña web. De forma predeterminada, la campaña web será visible para todos los visitantes.

   ![](assets/web-campaign-audience.png)

   También puede seleccionar una audiencia específica. Utilice la variable **[!UICONTROL Select audience]** para mostrar la lista de segmentos disponibles de Adobe Experience Platform. [Más información sobre los segmentos](../segment/about-segments.md)
...
1. En el **[!UICONTROL Identity namespace]** , elija el área de nombres que desea utilizar para identificar a las personas del segmento seleccionado. [Más información sobre áreas de nombres](../event/about-creating.md#select-the-namespace)

1. Defina un **[!UICONTROL Schedule]** para su campaña web. [Más información](../campaigns/create-campaign.md#schedule)
...
Una vez definido el [configuración de campañas web](#configure-web-campaign) y editó el contenido según sus preferencias utilizando la variable [diseñador web](author-web.md), puede revisar y activar su campaña web. Siga los pasos a continuación.
...
1. En la campaña web, seleccione **[!UICONTROL Review to activate]**.
...
1. Select **[!UICONTROL Activate]**.
   ...
   >[!NOTE]
   >
   >Después de hacer clic en **[!UICONTROL Activate]**, los cambios de las campañas web pueden tardar hasta 15 minutos en estar disponibles en el sitio web.

La campaña web toma la variable **[!UICONTROL Live]** y ahora es visible para la audiencia seleccionada. Cada destinatario de la campaña puede ver las modificaciones que agregó al sitio web mediante la [!DNL Journey Optimizer] diseñador web.

>[!NOTE]
>
>Si ha definido una programación para su campaña web, tiene la variable **[!UICONTROL Scheduled]** hasta que se alcancen la fecha y hora de inicio.
>
...
1. En el menú superior, seleccione **[!UICONTROL Stop campaign]**.
