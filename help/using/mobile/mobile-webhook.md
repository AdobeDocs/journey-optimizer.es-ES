...
**En esta página:** Aprenda a crear webhooks de SMS de entrada y comentarios en Adobe Journey Optimizer para capturar las respuestas de consentimiento de inclusión y exclusión y los eventos de envío para Sinch, Infobip y los proveedores personalizados.
...
1. Configure las opciones del webhook, como se detalla a continuación:
   ...
   * **[!UICONTROL Credenciales de API]**: elija en la lista desplegable sus [credenciales de API configuradas anteriormente](mobile-configuration-sinch.md).
...
➡️[Más información sobre la configuración del canal](mobile-configuration-surface.md)
...
1. Configure las opciones del webhook, como se detalla a continuación:
   ...
   * **[!UICONTROL Credenciales de API]**: elija en la lista desplegable sus [credenciales de API configuradas anteriormente](mobile-configuration-infobip.md#api-credential).
...
1. Configure las opciones del webhook, como se detalla a continuación:
   ...
   * **[!UICONTROL Credenciales de API]**: elija en la lista desplegable sus [credenciales de API configuradas anteriormente](mobile-configuration-custom.md).
...
1. Cree una carga útil personalizada que coincida con el JSON proveniente del proveedor. Tenga en cuenta que el único formato de gancho web admitido es JSON. No se admiten datos de formulario para webhooks.
   ...
   * **InboundNumber**: El número de teléfono usado para esta configuración de webhook.
   ...
   >[!TIP]
   >
   > Abra la **[!UICONTROL Guía de instalación]** para obtener una carga útil JSON de ejemplo e instrucciones paso a paso.
