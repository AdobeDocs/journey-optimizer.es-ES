...
**En esta página:** Aprenda a configurar Sinch como su proveedor en Adobe Journey Optimizer configurando credenciales de API independientes para mensajes SMS, MMS y RCS.
