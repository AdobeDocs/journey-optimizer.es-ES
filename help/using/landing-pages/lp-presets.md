...
1. Si desea seleccionar el subdominio de página de aterrizaje para la dirección URL de seguimiento, marque la casilla de verificación **[!UICONTROL Same as landing page subdomain]** . [Más información sobre el seguimiento](../email/message-tracking.md)
...
* [Crear una página de aterrizaje](../landing-pages/create-lp.md#create-a-lp)
