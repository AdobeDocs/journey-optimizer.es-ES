...
1. En la subpágina, coloque el puntero del ratón donde desee insertar el texto y seleccione **[!UICONTROL Add personalization]** de la barra de herramientas contextual.

   ![](assets/lp_designer-form-subpage-perso.png)

1. En el **[!UICONTROL Edit personalization]** ventana, seleccione **[!UICONTROL Contextual attributes]** > **[!UICONTROL Landing Pages]** > **[!UICONTROL Primary Page Context]** > **[!UICONTROL Subscription]**.
