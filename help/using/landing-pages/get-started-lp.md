...
* Permitir que los clientes **acepten o excluyan** comunicaciones de marketing o un servicio o boletín específico, desde un vínculo en un correo electrónico o una campaña
...
1. [**Probar y publicar**](manage-lp.md): obtenga una vista previa de la página, pruebe el comportamiento del formulario y, a continuación, publíquelo para activarlo.
...
* Configure **flujos de inclusión y exclusión** de forma rápida y sin problemas, incluidas las listas de suscripción para permitir que los usuarios acepten o excluyan un servicio específico. [Más información](lp-use-cases.md#subscription-to-a-service)
