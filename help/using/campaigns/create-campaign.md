...
title: Crear una campaña de acción
...
1. [Programar la campaña de acción](campaign-schedule.md). De forma opcional, [envíe mediante olas](../delivery/send-using-waves.md) para entregar el mensaje en lotes a lo largo del tiempo.
