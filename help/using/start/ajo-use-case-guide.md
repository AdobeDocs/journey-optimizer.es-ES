...
title: ¿Qué capacidad de Journey Optimizer hay para este trabajo?
description: Una guía de decisión con prioridad de objetivos que asigna los objetivos comunes del profesional a la capacidad correcta de Adobe Journey Optimizer, con tutoriales prácticos, para que pueda encontrar la herramienta adecuada para lo que desea lograr y comenzar rápidamente.
feature: Get Started
...
# ¿Qué capacidad de Journey Optimizer hay para este trabajo? {#ajo-use-case-guide}
...
Comience con el canal que desee enviar en: [Correo electrónico](../email/get-started-email.md) · [Push](../push/get-started-push.md) · [SMS/MMS/RCS](../mobile/get-started-mobile.md) · [Web](../web/get-started-web.md) · [En la aplicación](../in-app/get-started-in-app.md). Para obtener instrucciones específicas de dispositivos móviles, explore [Centro de aprendizaje móvil](https://experienceleague.adobe.com/es/docs/journey-optimizer-learn/mobile-learning-hub/overview){target="_blank"}.

## Medir y optimizar {#measure-optimize}

Rastree el rendimiento y perfeccione: [Informes en vivo](../reports/live-report.md) · [Supervise y analice su recorrido con informes en vivo](https://experienceleague.adobe.com/es/docs/journey-optimizer-learn/tutorials/report-and-monitor/monitor-and-analyze-your-journey-with-live-reports){target="_blank"}. Para analizar experimentos y obtener recomendaciones de paso siguiente, usa el [Experimentation Agent](ai-features.md#experimentation-agent) **(IA)** ([tutorial](https://experienceleague.adobe.com/es/docs/journey-optimizer-learn/tutorials/experimentation/experimentation-agent-overview){target="_blank"}).
