...
Consulte también la [descripción general del servicio Adobe Experience Platform Query](https://experienceleague.adobe.com/en/docs/experience-platform/query/home){target="_blank"}.
