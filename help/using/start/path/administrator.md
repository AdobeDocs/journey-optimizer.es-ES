...
1. **Establezca las configuraciones de canal**. Defina todos los parámetros técnicos necesarios para el correo electrónico, los SMS, las notificaciones push, push web, el correo postal y otros canales:
   ...
   * Configure el **Canal de SMS** para configurar todos los parámetros técnicos necesarios para SMS. [Más información](../../mobile/mobile-configuration.md)
...
* **Horas tranquilas**: configure conjuntos de reglas para exclusiones basadas en el tiempo en las que los mensajes no deben enviarse durante períodos específicos. [Más información](../../conflict-prioritization/quiet-hours.md)
