...
**En esta página:** configure y administre claves administradas por el cliente (CMK) para que pueda cifrar sus datos de Adobe Journey Optimizer con sus propias claves y mantenerlos protegidos en tránsito y en reposo.
