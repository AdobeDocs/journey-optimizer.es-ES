...
* Para permitir varias ejecuciones de eventos comerciales, active la opción correspondiente en la sección **[!UICONTROL Execution]** de las propiedades de recorrido.
