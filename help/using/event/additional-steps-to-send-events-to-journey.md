...
1. Obtenga la URL de entrada desde las API de Adobe Experience Platform. Obtenga más información en [Información general sobre las API de ingesta de transmisión](https://experienceleague.adobe.com/docs/experience-platform/ingestion/streaming/overview.html?lang=es){target="_blank"}.
1. Copie la carga útil de la previsualización de carga útil en el menú **[!UICONTROL Evento]**. Más información sobre [esta página](../event/about-creating.md#define-the-payload-fields).
