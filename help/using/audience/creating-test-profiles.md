...
1. En el **Grupos de campos** , a la izquierda, haga clic en **Añadir** y seleccione los grupos de campos adecuados. Asegúrese de añadir la variable **Detalles de prueba de perfil** grupo de campos.
