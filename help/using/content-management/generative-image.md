...
1. Haga clic en el icono de porcentaje para ver su **[!UICONTROL puntuación de alineación de marca]** e identificar cualquier desalineación con su marca.
   ...
   ![Puntuación de alineación de marca para las variaciones](assets/image-genai-6.png){zoomable="yes"}
...
1. Haga clic en el icono de porcentaje para ver su **[!UICONTROL puntuación de alineación de marca]** e identificar cualquier desalineación con su marca.
   ...
   ![Puntuación de alineación de marca para las variaciones](assets/push-gen-img-2.png){zoomable="yes"}
