...
**En esta página:** Aprenda a crear plantillas de contenido desde cero o guardando el contenido existente de la campaña o del recorrido como una plantilla reutilizable en Adobe Journey Optimizer.
...
1. Haga clic en **[!UICONTROL Crear]** y diseñe el contenido según sea necesario, del mismo modo que lo haría para cualquier contenido dentro de un recorrido o una campaña, según el canal que haya seleccionado.
   ...
   * [Definición del contenido SMS](../mobile/create-mobile-message.md#sms-content)
