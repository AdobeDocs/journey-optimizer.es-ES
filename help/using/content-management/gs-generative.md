...
>abstract="Una vez que haya elaborado y personalizado su envío, puede utilizar el Asistente de IA en Journey Optimizer para la mejora del contenido. Esta función simplifica el proceso de personalización y mejora del contenido al permitirle refinarlo, describiendo lo que desea generar."
...
>
>
>* Debe aceptar un [acuerdo de usuario](https://www.adobe.com/legal/licenses-terms/adobe-dx-gen-ai-user-guidelines.html){target="_blank"} antes de poder utilizar el Asistente de IA en Adobe Journey Optimizer. Para obtener más información, contacte con su representante de Adobe.

## Acceso al Asistente de IA {#generative-access}

Para acceder a la función del Asistente de IA en Adobe Journey Optimizer, los usuarios deben tener concedido el permiso **Generar contenido**. [Más información](../administration/permissions.md)
...
A continuación, se indican las directrices generales para utilizar el Asistente de IA en Adobe Journey Optimizer para la generación de correos electrónicos:
