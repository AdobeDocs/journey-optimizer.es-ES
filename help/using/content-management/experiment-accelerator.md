...
>[!AVAILABILITY]
>
> Experimentation Accelerator se encuentra actualmente en fase beta y sus funciones se están implementando progresivamente.
...
* **Monitorización de KPI**: rastrea métricas como el alza, los ingresos y la confianza entre experimentos.
...
Para acceder a **[!UICONTROL Experimentation Accelerator]**:

* En el menú de la izquierda, selecciona **[!UICONTROL Experimentation Accelerator]** en la lista desplegable **[!UICONTROL Experimentación]**.

* También puedes seleccionar **[!UICONTROL Experimentation Accelerator]** del conmutador de aplicaciones.

Tenga en cuenta que los usuarios que solo tengan una licencia de Target solo pueden acceder a ella a través del conmutador Aplicaciones.
