...
**En esta página:** Aprenda a personalizar las directrices de marca definiendo la identidad de marca, el estilo de escritura y las reglas de contenido visual en Adobe Journey Optimizer.
...
1. Seleccione un ejemplo para actualizarlo, reemplace la imagen o haga clic en el icono ![Dive image alt text](assets/do-not-localize/Smock_Delete_18_N.svg "Delete")para eliminarla.
