...
title: Generación de correo electrónico con el asistente de IA
description: Comience a generar contenido y recursos de correo electrónico con el asistente de IA
...
Utilice el asistente de IA para mejorar la eficacia de sus campañas creando correos electrónicos completos, fragmentos de texto personalizados e imágenes personalizadas que hablen directamente con su audiencia, lo que aumenta la participación y la interacción.
...
1. Después de crear y configurar la campaña de correo electrónico, haga clic en **[!UICONTROL Editar contenido]**.
...
1. Puede alternar el **[!UICONTROL Línea de asunto]** y **[!UICONTROL Preencabezado]** opciones para incluirlas en la generación de variantes.
...
1. Inserte campos de personalización para personalizar el contenido del correo electrónico en función de los datos de perfiles. A continuación, haga clic en **[!UICONTROL Simular contenido]** para controlar el procesamiento y comprobar la configuración de personalización con perfiles de prueba. [Más información](../personalization/personalize.md)
...
En el siguiente ejemplo, aprovecharemos el asistente de IA para mejorar el contenido de nuestro correo electrónico.
...
1. Rellene el **[!UICONTROL Detalles básicos]** para su campaña. Una vez finalizado, haga clic en **[!UICONTROL Editar contenido de correo electrónico]**.
...
1. Habilite la **[!UICONTROL Estilo de referencia]** para que el asistente de IA personalice el nuevo contenido en función del contenido de referencia. También puede cargar una imagen para añadir contexto a la variación.
