...
**En esta página:** Aprenda a leer el informe Campaña de experimentación en Adobe Journey Optimizer para comparar el rendimiento de las variantes mediante métricas como el alza, la confianza y la tasa de conversión para la métrica de éxito elegida.
