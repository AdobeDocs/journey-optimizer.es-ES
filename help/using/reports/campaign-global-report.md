...
Se puede acceder al informe global de campaña directamente desde la campaña con la variable **[!UICONTROL Reports]** botón.

![](assets/campaign_report_1.png)

Después de seleccionar la variable **[!UICONTROL All time]** , la pestaña **[!UICONTROL Global report]** se muestra con las siguientes pestañas:
