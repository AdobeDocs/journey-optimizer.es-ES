...
>[!NOTE]
>
>Si existen varias conexiones para su zona protegida, confirme que la [vista de datos](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/create-dataview.html?lang=es){target="_blank"} hace referencia a la [conexión](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/create-connection.html?lang=es){target="_blank"} marcada como **[!UICONTROL Usar en CJA]**. De lo contrario, el botón [**Analizar en CJA**](report-cja-manage.md#analyze) se puede deshabilitar en [!DNL Journey Optimizer].
