...
**En esta página:** Comprenda las métricas de SMS del informe de recorrido de Adobe Journey Optimizer, incluidas las tendencias de envíos y clics, los vínculos rastreados, los mensajes entrantes, los proveedores y las razones de rechazo, error y exclusión.

>[!ENDSHADEBOX]

>[!BEGINSHADEBOX]

Puede acceder a su informe de recorrido de SMS haciendo clic en el botón **[!UICONTROL Ver informe]** del recorrido. [Más información](report-gs-cja.md)
...
La tabla **[!UICONTROL Información general de campaña]** sirve como un panel para el rendimiento de SMS para cada acción de campaña en su recorrido. Resume los perfiles objetivo, las métricas de clics y clics (incluidos los clics estimados que excluyen el tráfico de interacción tanto humano como no humano) y los resultados de entrega, como devoluciones, errores de envío y exclusiones.
