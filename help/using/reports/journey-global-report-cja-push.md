...
**En esta página:** Comprenda las métricas de notificaciones push del informe de recorrido de Adobe Journey Optimizer, incluidas las estadísticas de envío y seguimiento, las etiquetas de vínculos rastreados y las direcciones URL, y los motivos de rechazo, error y exclusión.
...
Consulte [esta sección](campaign-global-report-cja-push.md#error-reasons-push) para obtener la lista detallada de las razones de error de inserción.
