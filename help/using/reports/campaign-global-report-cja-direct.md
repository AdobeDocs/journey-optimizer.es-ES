...
**En esta página:** Aprenda a leer el informe de campaña de correo directo en Adobe Journey Optimizer para revisar las estadísticas de envío, el estado de envío, los motivos de error y los motivos de exclusión de sus mensajes de correo directo.
