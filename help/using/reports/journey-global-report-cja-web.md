...
description: Aprenda a utilizar los datos web del informe de recorrido
...
**En esta página:** Comprenda las métricas del canal web en el informe de recorrido de Adobe Journey Optimizer, incluidas las tendencias de clics y impresiones, las visualizaciones, los datos de seguimiento y las direcciones URL y etiquetas de vínculos rastreados.
...
Puede acceder a su informe de recorrido web si hace clic en el botón **[!UICONTROL Ver informe]** del recorrido. [Más información](report-gs-cja.md)
