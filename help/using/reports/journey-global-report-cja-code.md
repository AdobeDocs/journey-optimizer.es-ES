...
description: Aprenda a utilizar datos basados en código del informe de recorrido
...
**En esta página:** Aprenda a leer las métricas de experiencia basadas en código del informe de recorrido, incluidos los datos de clics y visualización, los datos de seguimiento y las etiquetas de vínculos rastreados de las experiencias basadas en código.
