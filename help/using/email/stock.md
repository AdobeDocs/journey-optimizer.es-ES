...
1. Personalice la imagen, si es necesario, con **[!UICONTROL Configuración]** y **[!UICONTROL Estilos]** pestañas. [Más información sobre la configuración de componentes](content-components.md).
...
* [Configuración de componentes para el diseño de correo electrónico](content-components.md)
