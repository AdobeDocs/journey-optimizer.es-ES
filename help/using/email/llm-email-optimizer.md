---
title: Optimización del correo electrónico para bandejas de entrada de IA
...
# Optimización del correo electrónico para bandejas de entrada de IA {#email-text-optimizer}

>[!BEGINSHADEBOX]

**En esta página:** Aprenda a generar y perfeccionar una versión específica de su correo electrónico en el Designer de correo electrónico para que los clientes de la bandeja de entrada asistida por IA basen sus resúmenes y respuestas en sus ofertas y llamadas a la acción.
...
Puede utilizar esta capacidad para generar y refinar una versión dedicada de sus mensajes, de modo que las experiencias de la bandeja de entrada asistida por IA tengan más probabilidades de mostrar las ofertas, las llamadas a la acción y los detalles que pretenda, en lugar de un texto generado automáticamente o un contexto no relacionado.
...
* Las respuestas proporcionadas por estos asistentes de IA pueden ser un breve resumen (por ejemplo, que el mensaje es promocional, menciona el acceso anticipado de VIP y una venta, e incluye vínculos a categorías de productos). Sin embargo, todavía omiten los objetivos que el experto en marketing quería porque los asistentes deducen del texto que ven efectivamente, no necesariamente de la historia completa que pretendía.
...
Para optimizar el contenido del correo electrónico para las experiencias de la bandeja de entrada de IA con [!DNL Journey Optimizer], siga los pasos a continuación.
...
1. La versión generada se muestra en la ventana **[!UICONTROL AI Inbox Optimizer]**.

   ![Versión generada optimizada para bandejas de entrada de IA](assets/optimize-ai-inbox-output.png){zoomable="yes" width="80%"}

   >[!NOTE]
   >
   >La versión optimizada es diferente de las vistas HTML y de texto del correo electrónico. No cambia el diseño, el diseño ni las imágenes.

1. Para editar el contenido generado automáticamente, seleccione la opción **[!UICONTROL Habilitar edición]** y realice los cambios manuales que sean necesarios.

1. Una vez que esté satisfecho con su versión, haga clic en el botón **[!UICONTROL Optimizar correo electrónico]** para confirmar. También puedes usar el botón **[!UICONTROL Reoptimizar]** para generar una nueva versión.

1. Se le redirigirá a la vista **[!UICONTROL HTML]** y su correo electrónico se ha optimizado correctamente para las bandejas de entrada de IA. Para volver a acceder o editar la versión optimizada, haga clic en el botón **[!UICONTROL Bandeja de entrada optimizada para IA]**.
...
1. Se muestra la versión optimizada. Puede **[!UICONTROL Quitar optimización]** o hacer clic en **[!UICONTROL Volver a optimizar]** para generar una nueva versión.
   ...
   >[!NOTE]
   >
   >Si realiza cambios en el contenido original de HTML, debe volver a optimizar la versión generada para las bandejas de entrada de IA de modo que sea coherente con el nuevo contenido.
