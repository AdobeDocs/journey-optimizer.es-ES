...
+ Novedades {#whats-new}
  ...
  + {hide-from-toc}[Notas de la versión preliminar](using/rn/e-release-notes.md)
  + [Últimas notas de la versión](using/rn/release-notes.md)
  + Notas de la versión anterior {#previous-rn-new}
    + {hide-from-toc}[Notas de la versión anterior](/help/rp_landing_pages/previous-rn-new-landing-page.md)
...
+ Introducción {#get-started}
  ...
  + Características esenciales {#essentials}
    ...
    + {hide-from-toc}[Recorridos frente a campañas - 2](using/start/journeys-vs-campaigns-v2.md)
...
+ Recorridos {#orchestrate-journeys}
  ...
  + Expresiones de compilación {#building-advanced-conditions-journeys}
    ...
    + Sintaxis {#syntax}
      ...
      + {hide-from-toc}[Ejemplos](using/building-journeys/expression/advanced-editor-use-cases.md)
...
+ Desafíos de lealtad {#loyalty-challenges}
  ...
  + Crear y administrar retos {#create-manage-challenges}
    ...
    + [Crear tareas](using/loyalty-challenges/create-tasks.md)
    + [Monitorizar el rendimiento del reto de lealtad](using/loyalty-challenges/loyalty-reporting.md)
  + Configurar e integrar {#configure-integrate-loyalty}
    + [Configurar retos de lealtad](using/loyalty-challenges/loyalty-admin.md)
    + [Guía de definición de recompensas](using/loyalty-challenges/reward-definition-guide.md)
    + [Guía del transformador de eventos](using/loyalty-challenges/event-transformer-guide.md)
    + [Permisos de retos de lealtad](using/loyalty-challenges/loyalty-permissions.md)
    + [Datos y conjuntos de datos de lealtad](using/loyalty-challenges/loyalty-data-and-datasets.md)
    + [API de retos de lealtad](using/loyalty-challenges/loyalty-challenges-api.md)
+ Campañas {#campaigns}
  ...
  + Campañas activadas por API {#api-triggered-campaigns}
    ...
    + [Trabajar con campañas activadas por API](using/campaigns/api-triggered-campaigns.md)
  ...
  + Campañas orquestadas {#orchestrated-campaigns}
    ...
    + Lanzamiento de su primera campaña orquestada {#launch}
      ...
      + [Adición de personalización](using/orchestrated/add-personalization.md)
    ...
    + Actividades de las campañas organizadas {#design-campaigns}
      ...
      + [Carga de archivo](using/orchestrated/activities/load-file.md)
...
+ Configuración del envío {#delivery-settings}
  + [Envío por oleadas](using/delivery/send-using-waves.md)
  + [Optimización de la hora de envío](using/building-journeys/send-time-optimization.md)
...
+ Prueba y aprobación {#test}
  ...
  + Vista previa y prueba del contenido {#preview-test}
    ...
    + {hide-from-toc}[Simular experiencias entrantes](using/test-approve/simulate-inbound-experiences.md)
    + [Simulación de variaciones de contenido (experiencia clásica)](using/test-approve/simulate-sample-input.md)
    + [Simulación de variaciones de contenido (nueva experiencia)](using/test-approve/simulate-content-variations.md)
...
+ Canales de comunicación {#channels}
  ...
  + Canal de correo electrónico {#email}
    ...
    + Diseño del contenido del correo electrónico {#design-email}
      ...
      + Creación del contenido {#add-content}
        ...
        + [Uso de módulos](using/email/email-modules.md)
        ...
        + [Personalizar direcciones URL](using/email/url-personalization.md)
        + [Inserción de ofertas personalizadas](using/email/add-offers-email.md)
        + [Optimización del correo electrónico para bandejas de entrada de IA](using/email/llm-email-optimizer.md)
        + [Administrar la versión de texto](using/email/text-version-email.md)
        + [Añadir metadatos](using/email/email-metadata.md)
        + [Editar con el editor avanzado de HTML](using/email/email-expert-mode.md)
  ...
  + Canal en la aplicación {#in-app}
    ...
    + Configurar el canal en la aplicación {#configure-inapp}
      + [Configuración de canal en la aplicación y requisitos previos](using/in-app/inapp-configuration.md)
      + [Configurar la mensajería web en la aplicación en el SDK web](using/in-app/web-in-app-messaging.md)
  + Canal de notificaciones push {#push}
    ...
    + Configuración de notificaciones push {#push-config}
      ...
      + [Configuración de canal de notificaciones push web](using/push/push-configuration-web.md)
  ...
  + Canal de SMS/MMS/RCS {#mobile}
    ...
    + [Generar informe de uso de SMS](using/mobile/sms-usage-report.md)
  ...
  + Canal web {#web}
    ...
    + Aplicaciones de una sola página y SDK web {#web-sdk}
      ...
      + [Journey Optimizer con SDK web de Experience Platform](using/web/web-sdk.md)
  ...
  + Bandeja de entrada {#inbox}
    ...
    + [Configuración de la compatibilidad con la bandeja de entrada en el SDK web](using/inbox/inbox-configuration-sdk.md)
  ...
  + Actividades en directo {#live-activity}
    ...
    + [Resolución de problemas de actividades en directo](using/mobile-live/troubleshoot-mobile-live.md)
    + [Preguntas frecuentes](using/mobile-live/mobile-live-faq.md)
    + Configuración del canal de actividades en directo {#configure-live-activity}
      + [Configuración de actividad en directo en Journey Optimizer](using/mobile-live/mobile-live-configuration.md)
      + [Configuración de la integración de SDK de actividades en directo](using/mobile-live/mobile-live-configuration-sdk.md)
  + Canales personalizados {#custom-channel}
    + [Introducción a los canales personalizados](using/custom-channel/get-started-custom-channel.md)
    + Configuración de los canales personalizados {#configure-custom-channel}
      + [Configuración de sus canales personalizados](using/custom-channel/configure-custom-channel.md)
      + [Creación de un canal personalizado](using/custom-channel/create-custom-channel.md)
      + [Administración de las credenciales de API](using/custom-channel/custom-channel-api-credentials.md)
      + [Delegación de un subdominio](using/custom-channel/custom-channel-subdomains.md)
      + [Creación de una configuración de canal](using/custom-channel/custom-channel-configuration.md)
    + Creación de experiencias de canal personalizadas {#create-custom-channel-experiences}
      + [Creación de una experiencia de canal personalizada](using/custom-channel/create-custom-experience.md)
      + [Pruebe su experiencia de canal personalizado](using/custom-channel/test-custom-channel.md)
...
+ Gestión de contenidos {#content-management}
  ...
  + Personalización {#personalization}
    ...
    + Lista de funciones del asistente {#functions}
      ...
      + {hide-from-toc}[Ayuda de búsqueda de datos externos](using/personalization/external-data-lookup.md)
  ...
  + Páginas de aterrizaje {#landing-pages}
    ...
    + [Uso de los formularios en las páginas de destino](using/landing-pages/lp-forms.md)
  ...
  + Plantillas de contenido {#content-templates}
    ...
    + [Conversión de imágenes en plantillas de correo electrónico](using/content-management/image-to-html.md)
  ...
  + Fragmentos de contenido reutilizables {#fragments}
    ...
    + [Fragmentos dinámicos](using/content-management/dynamic-fragments.md)
    + [Administración de fragmentos](using/content-management/manage-fragments.md)
    + {hide-from-toc}[Añadir atributos contextuales a fragmentos publicados](using/content-management/manage-fragments-contextual-attributes.md)
  ...
  + Casos de uso entre soluciones {#combine}
    ...
    + [Integración con servicios inteligentes](using/integrations/intelligent-services.md)
  ...
  + Generar contenido {#generate-content}
    ...
    + Metadatos de C2PA {#c2pa}
      ...
      + [Metadatos de C2PA en el diseñador de correo electrónico y de páginas de destino](using/content-management/c2pa-metadata-email-designer.md)
    ...
    + [Generar contenido para expresiones de personalización](using/content-management/generative-personalization-expressions.md)
    + [Generar casos de uso de contenido](using/content-management/generative-uc.md)
    + Marcas {#brands}
      ...
      + [Creación y administración de modelos generativos](using/content-management/generative-models.md)
      + [Evaluación del contenido](using/content-management/brands-score.md)
...
+ Creación de informes {#reporting}
  ...
  + Informe de todo el tiempo {#channel-report}
    ...
    + Informes de campaña {#campaign-reporting}
      ...
      + [Informe de campaña de canal personalizado](using/reports/campaign-global-report-cja-custom.md)
      ...
      + {hide-from-toc}[Informe de campaña de actividad en directo](using/reports/campaign-global-report-cja-activity.md)
...
+ Capacidades de decisión {#decisioning}
  ...
  + Toma de decisiones {#experience-decisioning}
    ...
    + Migración a la toma de decisiones {#migrate-to-decisioning}
      + [Ventajas de migrar a la toma de decisiones](using/experience-decisioning/migrate-to-decisioning.md)
      + [API de migración de la toma de decisiones](using/experience-decisioning/decisioning-migration-api.md)
    + Referencia de la API {#experience-decisioning-api-reference}
      + {hide-from-toc}[Referencia de API](/help/rp_landing_pages/experience-decisioning-api-reference-landing-page.md)
    ...
    + Creación de clasificaciones {#experience-decisioning-rankings}
      ...
      + Modelos de IA {#experience-decisioning-ai-models}
        ...
        + [Monitorización del rendimiento de los modelos de IA](using/experience-decisioning/ranking/ai-model-observability.md)
  ...
  + Gestión de decisiones {#offer-decisioning}
    ...
    + Creación y administración de ofertas {#managing-offers-in-the-offer-library}
      ...
      + Configuración de ofertas {#configure-offers}
        ...
        + [Funciones admitidas en el editor de personalización](using/offers/offer-library/personalization-editor-supported-functions.md)
...
+ Administración de datos {#data-management}
  ...
  + [Monitorización de datos entrantes con Edge](using/data/monitoring.md)
...
+ Configuración de canal {#configuration}
  ...
  + Implementar un plan de calentamiento de IP {#implement-ip-warmup-plan}
    ...
    + {hide-from-toc}[Archivos del plan de calentamiento de IP](using/configuration/ip-warmup-plan-files.md)
  + Monitorizar las direcciones de correo electrónico {#monitor-reputation}
    ...
    + {hide-from-toc}[Tipos de errores de correo electrónico](using/configuration/email-error-types.md)
  ...
  + [Compatibilidad con el archivado de correos electrónicos](using/configuration/archiving-support.md)
  ...
  + [Administrar IP permitidas](using/configuration/waf-ip-allowlist.md)
