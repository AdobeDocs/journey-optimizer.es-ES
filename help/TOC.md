...
+ Recorridos {#orchestrate-journeys}
   ...
   + {hide-from-toc}[tipos de Recorrido: elija el correcto](using/building-journeys/journey-types-selection.md)
...
+ Campañas {#campaigns}
   ...
   + Campañas orquestadas {#orchestrated-campaigns}
      ...
      + Actividades de las campañas organizadas {#design-campaigns}
         ...
         + {hide-from-toc}[Cargar archivo](using/orchestrated/activities/load-file.md)
