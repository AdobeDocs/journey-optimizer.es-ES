...
+ Introducción {#get-started}
   ...
   + Características esenciales {#essentials}
      ...
      + {hide-from-toc}[Capacidades por paquete](using/start/ajo-packages.md)
      + {hide-from-toc}[Paquetes y funciones (v2)](using/start/ajo-packages-v2.md)
      + {hide-from-toc}[Paquetes y funciones (v3)](using/start/ajo-packages-v3.md)
...
+ Recorridos {#orchestrate-journeys}
   ...
   + Crear un recorrido {#create-journey}
      ...
      + {hide-from-toc}[Introducción a la simulación de Recorrido](using/building-journeys/simulate-journey-gs.md)
      + {hide-from-toc}[Simular tu recorrido](using/building-journeys/simulate-journey-2.md)
