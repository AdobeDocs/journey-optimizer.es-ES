...
+ Prueba y aprobación {#test}
   ...
   + Vista previa y prueba del contenido {#preview-test}
      ...
      + {hide-from-toc}[Generación automática de variantes de contenido](using/test-approve/simulate-sample-input-generated.md)
   ...
   + Canal de correo electrónico {#email}
      ...
      + Diseño del contenido del correo electrónico {#design-email}
         ...
         + Diseño del contenido {#add-content}
            ...
            + {hide-from-toc}[Optimizar correo electrónico para bandejas de entrada de IA](using/email/llm-email-optimizer.md)
...
+ Gestión de contenidos {#content-management}
   ...
   + Casos de uso entre soluciones {#combine}
      ...
      + {hide-from-toc}[Trabajar con herramientas de IA mediante MCP - Oculto](/help/using/integrations/ajo-mcp.md)
