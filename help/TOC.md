...
+ Recorridos {#orchestrate-journeys}
   ...
   + Administrar los recorridos {#manage-journey}
      ...
      + {hide-from-toc}[Objeto de recorrido](using/building-journeys/journey-fragments.md)
...
+ Canales de comunicación {#channels}
   ...
   + Canal de correo electrónico {#email}
      ...
      + Configuración de canal de correo electrónico {#configure-email}
         ...
         + [Configuración de vínculos profundos en correos electrónicos](using/email/deeplinks.md)
   ...
   + Canal de SMS/MMS/RCS {#sms}
      ...
      + Configuración de canales de SMS/MMS/RCS {#configure-sms}
         ...
         + [Usar un conjunto de datos personalizado para palabras clave entrantes](using/sms/custom-dataset-inbound-keywords.md)
