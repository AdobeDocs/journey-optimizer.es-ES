...
+ Novedades {#whats-new}
   ...
   + Nueva función de creación en línea {#inline-authoring}
      + [Información general sobre migración](using/rn/inline-messages.md)
      + [Pasos de migración](using/rn/inline-messages-steps.md)
...
+ Diseño de contenido {#design}
   ...
   + Diseño de contenido {#design-content}
      ...
      + [Ajustar alineación vertical y relleno](using/design/adjusting-vertical-alignment-and-padding.md)
      + [Definición de un estilo para los vínculos](using/design/styling-links.md)
      + [Añadir atributos de estilo en línea](using/design/adding-inline-styling-attributes.md)
...
+ Personalización{#personalization}
   ...
   + Expresiones de compilación {#build-expressions}
      ...
      + Funciones de ayuda{#functions}
         ...
         + [Funciones de fecha y hora](using/personalization/functions/dates.md)
...
+ Administración de datos {#data-management}
   ...
   + Conjuntos de datos {#datasets}
      + [Introducción a los conjuntos de datos](using/start/get-started-datasets.md)
      + [Ejemplos de consultas](using/start/datasets-query-examples.md)
   ...
   + Configurar mensajes {#configuration-message}
      ...
      + Configuración de correos electrónicos {#email-configuration}
         ...
         + Supervisar las direcciones de correo electrónico {#monitor-reputation}
            ...
            + [Lista de permitidos](using/configuration/allow-list-temp.md)
...
+ Privacidad {#privacy}
   ...
   + [Acciones de auditoría en recursos de Journey Optimizer](using/privacy/audit-logs.md)
